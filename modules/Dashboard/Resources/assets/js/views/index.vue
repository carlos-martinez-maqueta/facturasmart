<template>
  ...
  <div class="col-xl-6 col-md-8">
    <section class="card card-dashboard" style="margin-bottom: 10px;">
      <!-- Loader section -->
      ...
      <!-- Ventas por producto section -->
      <div class="card-body pb-0" v-show="!loaders.items_by_sales" style="

        border-radius: 8px;

        padding: 10px;
        margin: 5px 0;">
        <h3 class="small-title" style="
          font-size: 1.25em;
          margin-bottom: 10px;
          color: #007bff;">
          Ventas por producto
      ...
      <!-- Export and View all button section -->
      <div class="card-body" style="
        text-align: center;
        padding-top: 10px;">
<a class="btn btn-primary btn-sm" href="/reports/items/top">
  Ver todo
</a>
...
<template v-if="configuration.dashboard_clients">
  <div class="col-xl-6 col-md-8">
    <section class="card card-dashboard" style="margin-bottom: 10px;">
      ...
      <!-- Top clients section -->
      <div class="card-body pb-0" v-show="!loaders.top_customers" style="
        ...
        <ul class="top-customers-list" style="
          list-style-type: none;
          padding: 0;
          margin: 0;">
          <li v-for="client in topClientes" :key="client.id" class="top-customer-item" style="
            display: flex;
            align-items: center;
            padding: 5px;
            ...
            color: #555;
            font-size: 1.1em;">
            <div v-if="client.photo" style="
              width: 40px;
              height: 40px;
              border-radius: 50%;
              margin-right: 10px;">
              <img :src="client.photo" alt="Customer Photo" style="
                width: 100%;
                height: 100%;
                border-radius: 50%;">
            </div>
            <div v-else style="
              ...
              font-size: 1.2em;
              color: #830c0c;">
              {{ client.customer.charAt(0).toUpperCase() }}
            </div>
            <div style="flex-grow: 1;">
              <div style="font-weight: bold;">{{ client.customer }}</div>
      ...
      <div class="card-body" style="text-align: center; padding-top: 10px;">
        <a class="btn btn-primary btn-sm" href="/customers/top">
            Ver todo
        </a>
      </div>
    </section>
...
export default {
    ...
    data() {
        return {
            ...
            loaders: {},
            months: [],
            reportUrl: window.reportTopCustomersUrl, // URL del reporte
        };
    },
    async created() {

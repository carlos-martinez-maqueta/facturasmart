<template>
    <div>
        ...
        <div class="card mb-0">
                ...
                <data-table :resource="resource">
                    ...
                    <tr slot-scope="{ index, row }">
                        ...
                        <td class="text-center">
                            <el-button
                                v-if="row.number_document_sale_note"
                                type="primary"
                                size="mini"
                                @click="clickOptionsPdf(row)"
                            >
            ...
            <document-options
                :showClose="true"
                :showDialog.sync="showDocumentOptions"
                :recordId="recordDocumentId"
            ></document-options>
            <sale-note-options
                :showClose="true"
                :showDialog.sync="showSaleNoteOptions"
                :recordId="recordDocumentId"
            ></sale-note-options>
        </div>
    </div>
...
import Document from "../../../../../../../resources/js/views/tenant/perceptions/partials/document.vue";
    ...
    methods: {
        clickOptionsPdf(row) {
            if (row.document_id) {
                ...
                this.recordDocumentId = row.document_id;
            } else {
                this.showSaleNoteOptions = true;
                this.recordDocumentId = row.sale_note_id;
            }
        },
        ...mapActions([
            "loadConfiguration",

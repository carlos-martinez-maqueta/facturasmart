                        ...
                        <div class="row">
                            ...
                            <! -- <div class="col-md-6">
                                <div class="form-group" :class="{'has-danger': errors.prepayment}">
                                    ...
                                    <small class="text-danger" v-if="errors.prepayment" v-text="errors.prepayment[0]"></small>
                                </div>
                            </div> -->
                            <div class="col-md-6">
                                <div
                            ...
                            <div class="col-md-6">
                                <div
                                    :class="{
                                        'has-danger': errors.plate_number,
                                    }"
                                    class="form-group"
                                >
                            ...
                            <div class="col-md-6">
                                <div
                                    :class="{ 'has-danger': errors.km }"
                                    class="form-group"
                                >
                                    <label class="control-label"
                                        >Kilometraje
                                    </label>
                                    <el-input v-model="vehicle.km"></el-input>
                                    <small
                                        v-if="errors.km"
                                        class="text-danger"
                                        v-text="errors.km[0]"
...
import VehicleDetail from "./partials/vehicles_detail.vue";
...
export default {
    ...
    components: { PersonForm, VehicleDetail },
    data() {
        return {
            load_record: true,
    ...
    methods: {
        ...
        submit() {
            if (this.validateVehicle(this.vehicle)) {
                this.form.vehicle = this.vehicle;
            }
            ...
            if (this.form.items.length === 0) {
                return this.$message.error(
                    "Ingrese al menos un producto/servicio"
                );
            }
        ...
        changeCustomer() {
            ...
            console.log("🚀 ~ changeCustomer ~ customer:", customer);
            if (customer.address) {

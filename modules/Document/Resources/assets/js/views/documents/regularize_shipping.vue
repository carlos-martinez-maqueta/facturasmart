            ...
            <div class="card-body ">
                <data-table :resource="resource">
                    <tr slot="heading">
                        ...
                        <th>Comprobante</th>
                        <th>Descripción</th>
                        <th class="text-center">Consultar CDR
                            <el-tooltip
                                    class="item"
                                    effect="dark"
                                    placement="top-start"
                                >
                                    <div slot="content">
                                    <b>
                                        Esta opción verifica si existe un CDR (Constancia de Recepción) para la serie y número <br />
                                        Si se encuentra un CDR, se descarga y el documento se marca como aceptado. <br />
                                        Es importante tener en cuenta que esta opción no valida el contenido del documento. <br />
                                        por lo que se debe tener cuidado de no haber modificado el comprobante después de su aceptación por Sunat.
                                    </b>
                                    </div>

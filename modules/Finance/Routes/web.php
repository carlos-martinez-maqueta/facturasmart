        ...
        Route::middleware(['auth', 'redirect.module', 'locked.tenant'])->group(function() {
            ...
            Route::prefix('finances')->group(function () {
                ...
                Route::prefix('unpaid')->group(function () {
                    ...
                    Route::get('/multiple-pay/receipt/{multipayment_id}', 'UnpaidController@multiplePayReceipt');
                    ...
                    Route::get('/pdf_h', 'UnpaidController@pdf_h');
                    Route::get('/pdf_s', 'UnpaidController@pdf_s');

...
class ReportGeneralItemController extends Controller
{
    ...
    public function filter()
    {
        ...
        return compact(
            'zones',
            'document_types', 'suppliers', 'customers', 'items', 'web_platforms', 'brands', 'categories', 'users');
    }
    ...
    public function getRecordsItems($request)
    {
        ...
        $records = $this->dataItems($d_start, $d_end, $document_type_id, $data_type, $person_id, $type_person, $item_id, $web_platform_id, $brand_id, $category_id, $user_id, $user_type,$zone_id);
     ...
     */
    private function dataItems($date_start, $date_end, $document_type_id, $data_type, $person_id, $type_person, $item_id, $web_platform_id, $brand_id, $category_id, $user_id, $user_type,$zone_id = null)
    {

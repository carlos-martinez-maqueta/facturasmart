...
class OrderNote extends ModelTenant
{
    ...
    protected $fillable = [
        'dispatcher_id',
        'payment_condition_document_id',
        'number_transport_company',
    ...
    public function getCollectionData()
    {
        ...
        return [
            ...
            'payment_condition_document_id' => $this->payment_condition_document_id,
            'number_transport_company' => $this->number_transport_company,
            'name_transport_company' => $this->name_transport_company,
            'state' => $this->state,

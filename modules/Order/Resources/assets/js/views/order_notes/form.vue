                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-10 text-left mt-3 mb-0">
                            <address class="ib mr-2">
                                ...
                                <br />
                                <template v-if="config.establishment">
                                    <div
                                        v-if="
                                    ...
                                    {{
                                        config.establishment.district
                                            .description
                                    }},
                                    {{
                                        config.establishment.province
                                            .description
                                    }},
                                    {{
                                        config.establishment.department
                                            .description
                                    }}
                                    -
                                    {{
                    ...
                    <div class="form-body">
                        <div class="row mt-1">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-md-3 col-6">
                                    <div class="form-group">
                                        <label>Condición de pago CPE</label>
                                        <el-select
                                            v-model="
                                                form.payment_condition_document_id
                                            "
                                            clearable
                                        >
                                            <el-option
                                ...
                                <!-- <div class="col-lg-3 col-md-3 col-6">
                                    <div class="form-group">
                                        <label
                                            >Documento empresa transporte</label
                                        >
                                        <el-input
                                            v-model="
                                                form.number_transport_company
                                            "
                                        >
                                            <el-button
                                                slot="prepend"
...
export default {
    props: ["typeUser", "configuration", "user"],
    components: {
        OrderNoteFormItem,
        PersonForm,
        OrderNoteOptions,
    ...
    methods: {
        ...
        setAddressByCustomer() {
            ...
            if (customer) {
                this.form.shipping_address = customer.address;
                    this.dispatchesAddresses = customer.dispatch_addresses;
            }
        },
        ...
        initForm() {
            ...
            this.form = {
                state: 2,
                payment_condition_document_id: null,
                name_transport_company: null,
                payments: [],
                fee: [],

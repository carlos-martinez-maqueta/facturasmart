        ...
        <data-table :resource="resource">
          ...
          <tr slot-scope="{ index, row }">
            ...
            <td class="text-end">
              ...
              <button type="button" v-if="row.show_actions_row" class="btn waves-effect waves-light btn-sm btn-custom m-1__2"
              ...
              <button type="button" v-if="row.show_actions_row" class="btn waves-effect waves-light btn-sm btn-danger m-1__2"

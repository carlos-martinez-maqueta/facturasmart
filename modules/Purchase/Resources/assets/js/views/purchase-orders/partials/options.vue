    ...
    >
        <div class="row">
            <template v-if="form.upload_filename">
                <div
                    class="col-lg-6 col-md-6 col-sm-6 text-center font-weight-bold mt-4"
                >
                    <p>Imprimir A4</p>
                    <button
                        type="button"
            ...
            <template v-else>
                <div
                    class="col-lg-12 col-md-12 col-sm-12 text-center font-weight-bold mt-4"
                >
                    <p>Imprimir A4</p>
                    <button
                        type="button"
        ...
        <div class="row mt-3">
            ...
            <div class="col-md-12 mt-2">
                <el-input
                    ...
                    placeholder="Enviar link por WhatsApps"
                >
                    <template slot="prepend">+51</template>
...
export default {
    ...
    methods: {
        ...
        create() {
            this.$http
                ...
                .then((response) => {
                    ...
                    this.titleDialog =
                        `Orden de Compra ${typei}: ` + this.form.number_full;
                });
        ...
        clickFinalize() {
            ...
            window.open(`/${this.resource}`, "_self");
        },
        clickNewDocument() {
            this.clickClose();
        },
        clickClose() {
            if (this.external) {
                window.open(`/${this.resource}/create`, "_self");
            } else {

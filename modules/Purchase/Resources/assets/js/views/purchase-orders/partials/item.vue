                            ...
                            <table class="table">
                                ...
                                <tr v-for="(row, index) in item_unit_types"
                                    ...
                                    <td class="series-table-actions text-end">
                                        <button class="btn waves-effect waves-light btn-sm btn-success"
                                                type="button"
    ...
    methods: {
        ...
        async create() {
            //     this.initializeFields()
             if(this.item){
               console.log("🚀 ~ create ~ this.item:", this.item)
        ...
        calculateQuantity() {
            console.log("🚀 ~ calculateQuantity ~ this.form.item:", this.form.item)

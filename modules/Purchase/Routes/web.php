        ...
        Route::middleware(['auth', 'locked.tenant'])->group(function () {
            ...
            Route::prefix('purchase-orders')->group(function () {
                Route::prefix('reports')->group(function () {
                    Route::get('', 'PurchaseOrderController@reportIndex')->name('report.purchase-orders.index')->middleware('redirect.level');
                    Route::get('/columns', 'PurchaseOrderController@reportColumns');
                    Route::get('/records', 'PurchaseOrderController@reportRecords');
                    Route::get('/excel', 'PurchaseOrderController@reportExcel');
                    Route::get('/pdf', 'PurchaseOrderController@reportPdf');
                ...
                Route::get('generate-quotation/{id}', 'PurchaseOrderController@generateQuotation')->name('tenant.purchase-orders.generate');
                Route::get('tables', 'PurchaseOrderController@tables');
                ...
                Route::post('search/items', 'PurchaseOrderController@searchItemByIds');

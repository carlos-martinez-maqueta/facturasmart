                                ...
                                >
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <tr
                                                v-for="(
                                                    row, index
                                                ) in purchases_records"
                                                :key="index"
                                            >
                                                <td>
                                                    {{
                                                        purchasesCustomIndex(
                                                            index
                                                        )
                                                    }}
                                                </td>
                                    ...
                                    <div>
                                        <el-pagination
                                            ...
                                            :current-page.sync="
                                                purchases_pagination.current_page
                                            "
                                            :page-size="
                                                purchases_pagination.per_page
                                            "
                                        >
                                        </el-pagination>
                                    </div>
...
export default {
    ...
    methods: {
        ...
        async create() {
            await this.$http
                .get(`/${this.resource}/data-history/${this.recordId}`)
                .then((response) => {
        ...
        getPurchasesRecords() {
            ...
            return this.$http
                .get(
                    `/${
                        this.resource
                    }/history-purchases/records?${this.getPurchasesQueryParameters()}`
                )
                .then((response) => {
                    this.purchases_records = response.data.data;
                    this.purchases_pagination = response.data.meta;
                    this.purchases_pagination.per_page = parseInt(
                        response.data.meta.per_page
                    );
                })
                .then(() => {

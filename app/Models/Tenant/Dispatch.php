...
class Dispatch extends ModelTenant
{
    ...
    protected $fillable = [
        'supplier_id',
        'flete_payer_id',
        'flete_payment_number',
        'flete_payment_name',
        'secondary_driver_id',
        'secondary_transport_id',
        'secondary_driver',
        'secondary_transport_data',
        'alter_company',
        'purchase_order',
    ...
    protected $casts = [
        ...
        'secondary_transport_data' => 'array',
        'receiver_data' => 'array',
        'sender_data' => 'array',
        'sender_address_data' => 'array',
        'receiver_address_data' => 'array',
        'is_transport_category_m1l' => 'boolean'
    ];
    ...
    public function getSecondaryDriverAttribute($value)
    {
        return (is_null($value)) ? null : (object)json_decode($value);
    }

    public function setSecondaryDriverAttribute($value)
    {
        $this->attributes['secondary_driver'] = (is_null($value)) ? null : json_encode($value);
    }
    ...
    public function getCollectionData()
    {
        ...
        if ($this->state_type_id === '03' && !is_null($this->ticket) && !$is_pse) {
        ...
        return [
            'flete_payer_id' => $this->flete_payer_id,
            ...
            'message_ticket' => $this->message_ticket,
            ...
            'btn_edit' => $btn_edit,
            'tracto_carreta' => $this->tracto_carreta
        ];
    }
    ...
    public function flete_payer()
    {
        return $this->belongsTo(Person::class, 'flete_payer_id');
    }
    /**
     *

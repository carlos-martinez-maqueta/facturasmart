...
class   SaleNote extends ModelTenant
{
    ...
    {
        return $this->hasMany(SuscriptionPayment::class, 'sale_note_id');
    }
    ...
    public function getCollectionData(Configuration $configuration = null)
    {
        ...
        if ($dispatch_order) {
            ...
            if ($this->payment_condition_id == "01") {
                ...
                $payments_methods = $this->fee->map(function ($row) {
        ...
        return [
            ...
            'person_packer_id' => $this->person_packer_id,
            'person_dispatcher_id' => $this->person_dispatcher_id,
            ...
            'changed' => (bool)$this->changed,
            'enabled_concurrency' => (bool)$this->enabled_concurrency,

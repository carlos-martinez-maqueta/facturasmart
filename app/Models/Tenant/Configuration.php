...
class Configuration extends ModelTenant
{
    protected $fillable = [
        'item_complements',
        'show_dispatcher_documents_sale_notes_order_note',
        'show_email',
        ...
        'date_of_due_pdf',
        'qr_payments_pdf',
        'show_customer_telephone',
        'taxed_igv_visible_nv',
        'input_series_without_stock',
        'show_all_unpaid',
        'search_by_series_and_all',
        'show_item_sets',
        'export_mall',
        'pos_items_favorite',
        'pos_cash_counter',
        'pos_credit',
        'pos_bottles',
        'show_upload_items_excel_document',
        'emit_prepayment_document_from_sale_note',
        'show_internal_code_person',
        'change_name_click_item',
        'create_items_fast',
        'show_sale_price_pdf',
        'dispatchers_packers_document',
        'show_pending_credits',
        ...
        'num_column_kitchen',
        'show_edit_button',
        'condition_payment_items',
    ];

    protected $casts = [
        'show_customer_telephone' => 'boolean',
        'item_complements' => 'boolean',
        'show_dispatcher_documents_sale_notes_order_note' => 'boolean',
        'show_email' => 'boolean',
        'show_company_address' => 'boolean',
        'show_ubigeo' => 'boolean',
        'info_customer_pdf' => 'boolean',
        'date_of_due_pdf' => 'boolean',
        'qr_payments_pdf' => 'boolean',
        'condition_payment_items' => 'boolean',
        'taxed_igv_visible_nv' => 'boolean',
        'input_series_without_stock' => 'boolean',
        'show_all_unpaid' => 'boolean',
        'search_by_series_and_all' => 'boolean',
        'show_item_sets' => 'boolean',
        'export_mall' => 'boolean',
        'pos_items_favorite' => 'boolean',
        'pos_cash_counter' => 'boolean',
        'pos_credit' => 'boolean',
        'pos_bottles' => 'boolean',
        'show_upload_items_excel_document' => 'boolean',
        'emit_prepayment_document_from_sale_note' => 'boolean',
        'show_internal_code_person' => 'boolean',
        'change_name_click_item' => 'boolean',
        'create_items_fast' => 'boolean',
        'dispatchers_packers_document' => 'boolean',
        'show_pending_credits' => 'boolean',
        'show_total_quantity_document' => 'boolean',
        'show_total_quantity_document_presentation' => 'boolean',
        ...
        'all_sellers' => 'boolean',
        'block_seller_sale_note_edit' => 'boolean',
        'reopen_cash' => 'boolean',
        'yape_qr_documents' => 'boolean',
        'yape_qr_sale_notes' => 'boolean',
        'yape_qr_quotations' => 'boolean',
        'plin_qr_documents' => 'boolean',
        'plin_qr_sale_notes' => 'boolean',
        'plin_qr_quotations' => 'boolean',
        'locked_items' => 'boolean',
        'package_handlers' => 'boolean',
        'quotation_projects' => 'boolean',
        'show_no_stock' => 'bool',
        'admin_seller_cash' => 'bool',
        'erase_item_indivual' => 'bool',
        'pos_keyboard' => 'bool',
        'order_note_mode' => 'bool',
        'college' => 'bool',
    ...
    {
        if ($this->main_warehouse) {
            $warehouse = Warehouse::find($this->main_warehouse);
            return Establishment::find($warehouse->establishment_id);
        }
    ...
    public function getCollectionData()
    {
        ...
        $skins = Skin::all();
        return [
            'show_customer_telephone' => (bool) $this->show_customer_telephone,
            'item_complements' => (bool) $this->item_complements,
            'show_dispatcher_documents_sale_notes_order_note' => (bool) $this->show_dispatcher_documents_sale_notes_order_note,
            'show_email' => (bool) $this->show_email,
            'show_company_address' => (bool)$this->show_company_address,
            // 'email_customer_pdf' => (bool)$this->email_customer_pdf,
            'show_ubigeo' => (bool)$this->show_ubigeo,
            'info_customer_pdf' => (bool)$this->info_customer_pdf,
            'date_of_due_pdf' => (bool)$this->date_of_due_pdf,
            'qr_payments_pdf' => (bool)$this->qr_payments_pdf,
            'condition_payment_items' => (bool)$this->condition_payment_items,
            'taxed_igv_visible_nv' => (bool)$this->taxed_igv_visible_nv,
            'input_series_without_stock' => (bool)$this->input_series_without_stock,
            'show_all_unpaid' => (bool)$this->show_all_unpaid,
            'search_by_series_and_all' => (bool)$this->search_by_series_and_all,
            'show_item_sets' => (bool)$this->show_item_sets,
            'export_mall' => (bool)$this->export_mall,
            'pos_items_favorite' => (bool)$this->pos_items_favorite,
            'pos_cash_counter' => (bool)$this->pos_cash_counter,
            'pos_credit' => (bool)$this->pos_credit,
            'pos_bottles' => (bool)$this->pos_bottles,
            'show_upload_items_excel_document' => (bool)$this->show_upload_items_excel_document,
            'emit_prepayment_document_from_sale_note' => (bool)$this->emit_prepayment_document_from_sale_note,
            'show_internal_code_person' => (bool)$this->show_internal_code_person,
            'change_name_click_item' => (bool)$this->change_name_click_item,
            'create_items_fast' => (bool)$this->create_items_fast,
            'show_sale_price_pdf' => (bool)$this->show_sale_price_pdf,
            'show_edit_button' => (bool)$this->show_edit_button,
            'dispatchers_packers_document' => (bool)$this->dispatchers_packers_document,
            'show_pending_credits' => (bool)$this->show_pending_credits,
            'show_total_quantity_document' => (bool)$this->show_total_quantity_document,
            'show_total_quantity_document_presentation' => (bool)$this->show_total_quantity_document_presentation,
            'search_by_phone' => (bool)$this->search_by_phone,
            ...
            'all_sellers' => (bool)$this->all_sellers,
            'block_seller_sale_note_edit'  => (bool)$this->block_seller_sale_note_edit,
            'reopen_cash' => (bool)$this->reopen_cash,
            'yape_qr_documents' => (bool)$this->yape_qr_documents,
            'yape_qr_sale_notes' => (bool)$this->yape_qr_sale_notes,
            'yape_qr_quotations' => (bool)$this->yape_qr_quotations,
            'plin_qr_documents' => (bool)$this->plin_qr_documents,
            'plin_qr_sale_notes' => (bool)$this->plin_qr_sale_notes,
            'plin_qr_quotations' => (bool)$this->plin_qr_quotations,
            ...
            'pos_keyboard' => (bool)$this->pos_keyboard,
            'cash_report_hidden' => (bool)$this->cash_report_hidden,
            'order_note_mode' => (bool)$this->order_note_mode,
            'college' => (bool)$this->college,
            'shortcuts' => $this->shortcuts,
            'multi_sellers' => (bool)$this->multi_sellers,
            'id' => $this->id,
            'company' => $company,
            ...
            'view_tutorials' => (bool) $this->view_tutorials,
            'chatboot' => (bool) $this->chatboot,
            'delete_documents' => (bool) $this->delete_documents,
            ...
            'num_column_kitchen' => (int) $this->num_column_kitchen
        ];
    }
    ...
    {
        $this->update_document_on_dispaches = (bool)$update_document_on_dispaches;
        return $this;
    }
     ...
     * @return CatItemSize
     */
    public function setNewValidatorPagination(?int $new_validator_pagination)
    {

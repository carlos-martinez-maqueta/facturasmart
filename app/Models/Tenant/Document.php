 ...
 * @method static EloquentBuilder|Document whereToAnulate()
...
class Document extends ModelTenant
{
    ...
    public function scopeWhereToAnulate($query)
    {
    ...
    public function affected_documents2()
    {
    ...
    {
        if (
            !empty($this->regularize_shipping) &&

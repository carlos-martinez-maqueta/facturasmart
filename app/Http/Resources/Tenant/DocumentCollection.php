...
class DocumentCollection extends ResourceCollection
{
    ...
    public function toArray($request)
    {
        return $this->collection->transform(function ($row, $key) {
            ...
            $total_payment_prepayment = SaleNotePayment::where('document_prepayment_id', $row->id)->sum('payment');
    ...
    private function getDispatches($row)
    {
        ...
        if (in_array($row->document_type_id, ['01', '03'])) {
            ...
            // $dispatches_from_dispatches = Dispatch::where('document_id', $row->id)->get();
            // foreach ($dispatches_from_dispatches as $row) {

...
class DispatchController extends Controller
{
    ...
    public function create($document_id = null, $type = null, $dispatch_id = null)
    {
        ...
        if (!$document) {
            return view('tenant.dispatches.create', compact('series_default'));
        }
        ...
        return view('tenant.dispatches.form', compact('document', 'items', 'type', 'dispatch', 'series_default'));
    }
    ...
    public function store(DispatchRequest $request)
    {
        ...
        return [
            ...
            'data' => [
                ...
                'send_sunat' => $configuration->auto_send_dispatchs_to_sunat && !$company->pse,
            ],
        ];
    }
    ...
    public function tables(Request $request)
    {
        ...
        $establishments = $is_seller ? Establishment::where('id', auth()->user()->establishment_id)->get() : Establishment::all();
        $series = $is_seller ? Series::where('establishment_id', auth()->user()->establishment_id)->get() : Series::all();

...
<table class="full-width border-box mt-10 mb-10"> 
    ...
    @endphp
                ...
                <td class="pl-3"><strong>Contacto:</strong> {{ $contact->full_name }}</td>
            @endif
                            
            @isset($customer->telephone)
                <td class="pl-3"><strong>Teléfono:</strong> {{ $customer->telephone }}</td>
            @endisset
    </tbody>
</table>
<table class="full-width border-box mt-10 mb-10"> 
...
<table class="full-width mt-0 mb-0" >
    <thead >
        <tr class="">
            ...
            <th class="border-top-bottom text-center py-1 desc" class="cell-solid"  width="12%">Modelo</th>
            <th class="border-top-bottom text-center py-1 desc" class="cell-solid"  width="8%">Lote</th>
    ...
    <tbody class=""> 
        @foreach($document->items as $row)
            ...
            <tr>
                ...
                <td class="cell-solid-bottom p-1 text-center align-top desc cell-solid-rl">{{ symbol_or_code($row->item->unit_type_id) }}</td>
                <td class="cell-solid-bottom p-1 text-left align-top desc cell-solid-rl">
                ...
                <td class="cell-solid-bottom p-1 text-center align-top desc cell-solid-rl">{{ $row->item->model ?? '' }}</td>
                <td class="cell-solid-bottom p-1 text-center align-top desc cell-solid-rl">
            ...
            <table class="full-width">
                <tr>
                    @php
                        ...
                        $total_packages = $document->packages_number;
                    @endphp

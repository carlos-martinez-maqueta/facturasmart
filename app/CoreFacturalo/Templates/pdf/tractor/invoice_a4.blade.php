@php
    ...
    //calculate items
    $allowed_items = 54 - (\App\Models\Tenant\BankAccount::all()->count())*2;
...
<table class="full-width mt-0 mb-0">
    ...
    <tr class="">
        ...
        <th class="border-top-bottom text-right py-1 desc" class="cell-solid" width="18%">P.UNIT</th>
        <th class="border-top-bottom text-center py-1 desc" class="cell-solid" width="15%">TOTAL</th>
    </tr>
    </thead>
    <tbody class="">
    ...
    <tr>
        <td class="p-1 text-left align-top desc cell-solid" colspan="2"><strong>
                VENDEDOR:<br>
                </strong> {{ $document->user->name }}
                </td>
        <td class="p-1 text-left align-top desc cell-solid font-bold" colspan="2">
            SON:
    ...
    <tr>
        <td class="p-1 text-left align-top desc cell-solid" colspan="2" rowspan="6">
            @php
        ...
        <td class="p-0 text-center align-top desc cell-solid" colspan="2" rowspan="6">
...
<table class="full-width border-box my-2">
    ...
    <tr>
        ...
        <td width="80px">
            ...
            <td width="80px">Leyenda: Operación sujeta al Sistema de Pago de Obligaciones Tributarias con el Gobierno Central</td>

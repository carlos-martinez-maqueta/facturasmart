...
<body>
    ...
    <table class="full-width border-box mt-10 mb-10">
        ...
        <tbody>
            ...
            <tr>
                <td colspan="2">P.Partida: {{ $document->origin ? func_get_location($document->origin->location_id) : null }} -
                    {{ $document->origin ? $document->origin->address : null }}
                </td>
            </tr>
            <tr>
                <td colspan="2">P.Llegada: {{ $document->delivery ? func_get_location($document->delivery->location_id) : null }} -

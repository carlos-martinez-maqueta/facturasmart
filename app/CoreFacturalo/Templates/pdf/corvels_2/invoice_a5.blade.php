...
<table class="full-width mt-10 mb-10">
    ...
    @endif
        ...
        @endif
        <tr>
            <td colspan="6" class="text-right font-bold">IGV 18%: {{ $document->currency_type->symbol }}</td>
...
@if ($document->payment_condition_id === '01')
    ...
    <table class="full-width">
        <tr>
        <td>
        <strong>Condición de Pago:</strong> </td></tr>
            @php
                $payment = 0;
            @endphp
...
@else
    ...
    <table class="full-width">
        <tr>
            <td><strong>Condición de Pago: {{ $paymentMethod->description }}</strong></td>
        </tr>

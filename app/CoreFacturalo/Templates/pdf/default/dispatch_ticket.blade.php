...
<body>
    ...
    <table class="full-width border-box mt-10 mb-10">
        ...
        <tbody>
            ...
            <tr>
                <td>P.Partida:{{ $document->origin ? func_get_location($document->origin->location_id) : null }} - {{ $document->origin->address }}</td>
                <td>P.Llegada: {{ $document->delivery ? func_get_location($document->delivery->location_id) : null }} - {{ $document->delivery->address }}</td>
            </tr>
        </tbody>
    </table>
    <table class="full-width border-box mt-10 mb-10">

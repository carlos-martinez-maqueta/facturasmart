    ...
    <table class="full-width mt-10 mb-10">
        ...
        @endif
            ...
            @if ($document->total_charge > 0 && $document->charges)
                <tr>
                    <td colspan="4" class="text-right font-bold desc">CARGOS ({{ $document->getTotalFactor() }}%):
                        {{ $document->currency_type->symbol }}</td>
            ...
            @if ($change_payment < 0)
                <tr>
                    <td colspan="4" class="text-right font-bold desc">Vuelto: {{ $document->currency_type->symbol }}
                    </td>
    ...
    @if ($payments->count())
        ...
        <table class="full-width">
            ...
            @foreach ($payments as $row)
                <tr>
                    <td class="desc">- {{ $row->date_of_payment->format('d/m/Y') }} -
            ...
            @endforeach
            <tr>
                <td class="desc"><strong>Saldo:</strong> {{ $document->currency_type->symbol }}

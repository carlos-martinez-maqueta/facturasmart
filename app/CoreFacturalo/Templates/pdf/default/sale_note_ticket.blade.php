                                    @php
                                        ...
                                        $establishment__ = \App\Models\Tenant\Establishment::find(
                                        ...
                                        if ($logo) {
                                            ...
                                            $logo = str_replace(
                                                'storage/uploads/logos/storage/uploads/logos/',
                                        ...
                                        $accounts = \App\Models\Tenant\BankAccount::where(
                                            'show_in_documents',
                                            true,
                                        )->get();
                                        ...
                                        if ($is_integrate_system) {
                                            $quotation = \App\Models\Tenant\Quotation::select([
                                                'number',
                                                'prefix',
                                                'shipping_address',
                                            ])
                                    ...
                                    <body>
                                        ...
                                        @if ($document->transport)
                                            ...
                                            @php
                                                ...
                                                $destinatation_district_id =
                                                    (array) $transport->destinatation_district_id;
                                        ...
                                        @if ($document->transport_dispatch)
                                            @php
                                                ...
                                                $sender_identity_document_type =
                                                    $transport_dispatch->sender_identity_document_type->description;
                                                $recipient_identity_document_type =
                                                    $transport_dispatch->recipient_identity_document_type->description;
                                            @endphp
                                        ...
                                        <table class="full-width mt-10 mb-10">
                                            ...
                                            <tbody>
                                                ...
                                                @if ($configuration->taxed_igv_visible_nv)
                                                    <tr>
                                                        <td colspan="4" class="text-right font-bold desc">IGV:
                                                            {{ $document->currency_type->symbol }}</td>
                                                        <td class="text-right font-bold desc">
                                                ...
                                                <tr>
                                                    <td colspan="4" class="text-right font-bold desc">Total a
                                                        pagar:
                                                        {{ $document->currency_type->symbol }}</td>
                                                    <td class="text-right font-bold desc">
                                        ...
                                        @if (is_integrate_system())
                                            <table class="full-width">
                                                @php
                                                    $cot = \App\Models\Tenant\Quotation::where(
                                                        'id',
                                        ...
                                        <table class="full-width">
                                            @php
                                                $establishment_data = \App\Models\Tenant\Establishment::find(
                                                    $document->establishment_id,
                                                );
                                            @endphp
                                            <tbody>
                                            ...
                                            <div
                                                ...
                                                @foreach ($document->items as $row)
                                                    @if ($row->item->id_cupones)
                                                        @php
                                                            $coupon = \App\Models\Tenant\Coupon::find(
                                                                $row->item->id_cupones,
                                                            );
                                                        @endphp
                                                        @if ($coupon)
                                                            <div
                                                                ...
                                                                @if ($coupon->titulo)
                                                                    <p
                                                                        style="margin: 5px 0; font-size: 14px; font-weight: bold; color: #34495e;">
                                                                        {{ $coupon->titulo }}</p>
                                                                @endif
                                                                @if ($coupon->descripcion)
                                                                    <p
                                                                        style="margin: 5px 0; font-size: 13px; color: #7f8c8d;">
                                                                        {{ $coupon->descripcion }}</p>
                                                                @endif
                                                                @if ($coupon->descuento)
                                                                    <p
                                                                        style="margin: 5px 0; font-size: 13px; color: #27ae60;">
                                                                ...
                                                                @if ($coupon->fecha_caducidad)
                                                                    <p
                                                                        style="margin: 5px 0; font-size: 13px; color: #c0392b;">
                                                                ...
                                                                @if ($coupon->barcode)
                                                                    <p
                                                                        style="margin: 5px 0; font-size: 13px; color: #34495e; text-align: center;">
                                                                        <strong>Código de barras:</strong>
                                                                    </p>
                                                                    <div style="text-align: center;">
                                                                        <img src="{{ $coupon->barcode }}"
                                                                            alt="Barcode Image"

    ...
    <table class="full-width">
        <tr>
            ...
            <td width="20%" class="border-box py-2 px-2 text-center">
                ...
                <h5 style="vertical-align: top; text-transform: capitalize;" class="text-center">
                    {{ $document->document_type->description }}</h5>
        ...
        @isset($customer->search_telephone)
            @if ($customer->search_telephone != null)
                <tr>
                    <td>Telefono</td>
                    <td>:</td>
                    <td>{{ $customer->search_telephone }}</td>
                </tr>
            @endif
        @endisset
        @if ($customer->address !== '')
    ...
    <table class="full-width mt-10 mb-10">
        ...
        <tbody>
            ...
            @if ($document->total_plastic_bag_taxes > 0)
                <tr>
                    <td colspan="5" class="text-right font-bold">Icbper: {{ $document->currency_type->symbol }}
                    </td>
            ...
            @if ($document->total_discount > 0 && $document->subtotal > 0)
                <tr>
                    <td colspan="5" class="text-right font-bold">Subtotal: {{ $document->currency_type->symbol }}
                    </td>

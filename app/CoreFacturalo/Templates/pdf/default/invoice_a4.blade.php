...
<body>
    ...
    @endisset
        ...
        @if ($document->detraction && $invoice->operation_type_id == '1004')
            ...
            <tr>
                <td class="text-left desc" class="align-top" width="170px">Valor referencial servicio de transporte
                </td>
                <td class="text-left desc">:</td>
    ...
    <table class="full-width mt-10 mb-10">
        ...
        <tbody>
            ...
            @if ($document->total_exportation > 0)
                <tr>
                    <td class="text-left desc" colspan="{{ $colspan - 1 }}"
                        class="text-right desc font-bold desc">Op. Exportación:
            ...
            @if ($document->total_free > 0)
                <tr>
                    <td class="text-left desc" colspan="{{ $colspan - 1 }}"
                        class="text-right desc font-bold desc">Op. Gratuitas:
                        {{ $document->currency_type->symbol }}</td>
                    <td class="text-left desc" class="text-right desc font-bold desc">
            ...
            @if ($document->total_unaffected > 0)
                <tr>
                    <td class="text-left desc" colspan="{{ $colspan - 1 }}"
                        class="text-right desc font-bold desc">Op. Inafectas:
                        {{ $document->currency_type->symbol }}</td>
                    <td class="text-left desc" class="text-right desc font-bold desc">
            ...
            @if ($document->total_exonerated > 0)
                <tr>
                    <td class="text-left desc" colspan="{{ $colspan - 1 }}"
                        class="text-right desc font-bold desc">Op. Exoneradas:
                        {{ $document->currency_type->symbol }}</td>
                    <td class="text-left desc" class="text-right desc font-bold desc">
            ...
            @if ($document->document_type_id === '07')
                @if ($document->total_taxed >= 0)
                    <tr>
                        <td class="text-left desc" colspan="{{ $colspan - 1 }}" class="text-right desc">Op.
                            Gravadas:
            ...
            @if ($document->total_plastic_bag_taxes > 0)
                <tr>
                    <td class="text-left desc" colspan="{{ $colspan - 1 }}"
                        class="text-right desc font-bold desc">Icbper:
                        {{ $document->currency_type->symbol }}
                    </td>
                    <td class="text-left desc" class="text-right desc font-bold desc">
            ...
            @endif
            <tr>
                <td class="text-left desc" colspan="{{ $colspan - 1 }}" class="text-right desc">IGV:
                    {{ $document->currency_type->symbol }}
                </td>
            ...
            @if ($document->total_isc > 0)
                <tr>
                    <td class="text-left desc" colspan="{{ $colspan - 1 }}"
                        class="text-right desc font-bold desc">ISC:
                        {{ $document->currency_type->symbol }}</td>
                    <td class="text-left desc" class="text-right desc font-bold desc">
            ...
            @if ($document->total_discount > 0 && $document->subtotal > 0)
                <tr>
                    <td class="text-left desc" colspan="{{ $colspan - 1 }}"
                        class="text-right desc font-bold desc">Subtotal:
                        {{ $document->currency_type->symbol }}
                    </td>
                    <td class="text-left desc" class="text-right desc font-bold desc">
            ...
            @if ($document->total_discount > 0)
                <tr>
                    <td class="text-left desc" colspan="{{ $colspan - 1 }}"
                        class="text-right desc font-bold desc">
            ...
            @if ($document->total_charge > 0)
                @if ($document->charges)
                    ...
                    <tr>
                        <td class="text-left desc" colspan="{{ $colspan - 1 }}"
                            class="text-right desc font-bold desc">CARGOS ({{ $total_factor }}
                            %): {{ $document->currency_type->symbol }}</td>
                        <td class="text-left desc" class="text-right desc font-bold desc">
                ...
                @else
                    <tr>
                        <td class="text-left desc" colspan="{{ $colspan - 1 }}"
                            class="text-right desc font-bold desc">CARGOS:
                            {{ $document->currency_type->symbol }}</td>
                        <td class="text-left desc" class="text-right desc font-bold desc">
                            {{ number_format($document->total_charge, 2) }}</td>
                    </tr>
            ...
            @if ($document->perception)
                <tr>
                    <td class="text-left desc" colspan="{{ $colspan - 1 }}"
                        class="text-right desc font-bold desc">Importe total:
                        {{ $document->currency_type->symbol }}</td>
                    <td class="text-left desc" class="text-right desc font-bold desc">
                ...
                <tr>
                    <td class="text-left desc" colspan="{{ $colspan - 1 }}"
                        class="text-right desc font-bold desc">Percepción:
                        {{ $document->currency_type->symbol }}</td>
                    <td class="text-left desc" class="text-right desc font-bold desc">
                ...
                <tr>
                    <td class="text-left desc" colspan="{{ $colspan - 1 }}"
                        class="text-right desc font-bold desc">Total a pagar:
                        {{ $document->currency_type->symbol }}</td>
                    <td class="text-left desc" class="text-right desc font-bold desc">
            ...
            @elseif($document->retention)
                ...
                <tr>
                    <td class="text-left desc" colspan="{{ $colspan - 1 }}" class="text-right desc">TOTAL
                        RETENCIÓN
            ...
            @if (($document->retention || $document->detraction) && $document->total_pending_payment > 0)
                <tr>
                    <td class="text-left desc" colspan="{{ $colspan - 1 }}"
                        class="text-right desc font-bold desc">M. Pendiente:
                        {{ $document->currency_type->symbol }}</td>
                    <td class="text-left desc" class="text-right desc font-bold desc">
            ...
            @if ($balance < 0)
                <tr>
                    <td class="text-left desc" colspan="{{ $colspan - 1 }}"
                        class="text-right desc font-bold desc">Vuelto:
                        {{ $document->currency_type->symbol }}
                    </td>
                    <td class="text-left desc" class="text-right desc font-bold desc">

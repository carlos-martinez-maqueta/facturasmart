        ...
        <tbody>
            @foreach ($document->items as $row)
                <tr>
                    ...
                    <td style="font-size:11px;" class="text-center align-top">{{ symbol_or_code($row->item->unit_type_id) }}</td>
                    ...
                    <td style="font-size:11px;" class="text-right align-top">{{ number_format($row->unit_price, 2) }}
                    </td>
                    <td style="font-size:11px;" class="text-right align-top font-bold">
            ...
            @if ($document->total_exportation > 0)
                <tr>
                    <td colspan="5" class="text-right font-bold desc">Op. Exportación:
            ...
            @if ($document->total_free > 0)
                <tr>
                    <td colspan="5" class="text-right font-bold desc">Op. Gratuitas:
                        {{ $document->currency_type->symbol }}</td>
            ...
            @if ($document->total_unaffected > 0)
                <tr>
                    <td colspan="5" class="text-right font-bold desc">Op. Inafectas:
                        {{ $document->currency_type->symbol }}</td>
            ...
            @if ($document->total_exonerated > 0)
                <tr>
                    <td colspan="5" class="text-right font-bold desc">Op. Exoneradas:
                        {{ $document->currency_type->symbol }}</td>
            ...
            @if ($document->document_type_id === '07')
                @if ($document->total_taxed >= 0)
                    <tr>
                        <td colspan="5" class="text-right font-bold desc">Op. Gravadas:
                            {{ $document->currency_type->symbol }}</td>
            ...
            @if ($document->total_plastic_bag_taxes > 0)
                <tr>
                    <td colspan="5" class="text-right font-bold desc">Icbper:
                        {{ $document->currency_type->symbol }}</td>
            ...
            @endif
            <tr>
                <td colspan="5" class="text-right font-bold desc">IGV: {{ $document->currency_type->symbol }}
                </td>
            ...
            @if ($document->total_isc > 0)
                <tr>
                    <td colspan="5" class="text-right font-bold desc">ISC: {{ $document->currency_type->symbol }}
                    </td>
            ...
            @if ($document->total_discount > 0 && $document->subtotal > 0)
                <tr>
                    <td colspan="5" class="text-right font-bold desc">SUBtotal:
                        {{ $document->currency_type->symbol }}</td>
            ...
            @if ($document->total_discount > 0)
                <tr>
                    <td colspan="5" class="text-right font-bold desc">Descuento total:
                        {{ $document->currency_type->symbol }}</td>
            ...
            @if ($document->total_charge > 0)
                ...
                @else
                    <tr>
                        <td colspan="5" class="text-right font-bold desc">CARGOS:
                            {{ $document->currency_type->symbol }}</td>
                        <td class="text-right font-bold desc">{{ number_format($document->total_charge, 2) }}</td>
                    </tr>
                @endif
            ...
            <tr>
                <td colspan="5" class="text-right font-bold desc">Total a pagar:
                    {{ $document->currency_type->symbol }}</td>
            ...
            @if (($document->retention || $document->detraction) && $document->total_pending_payment > 0)
                <tr>
                    <td colspan="5" class="text-right font-bold desc">M. Pendiente:
                        {{ $document->currency_type->symbol }}</td>
            ...
            @if ($balance < 0)
                <tr>
                    <td colspan="5" class="text-right font-bold desc">Vuelto:
                        {{ $document->currency_type->symbol }}</td>

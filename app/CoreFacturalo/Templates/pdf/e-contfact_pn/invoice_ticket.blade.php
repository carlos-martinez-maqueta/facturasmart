...
<table class="full-width">
   ...
   {{-- <tr>
    ...
    <tr>
        <td class="text-center desc pt-2">Representación Impresa del <strong>COMPROBANTE ELECTRÓNICO</strong>, generado desde el Sistema del Contribuyente, para visualizar el documento visita: <strong> {!! url('/buscar') !!} </strong></td>
    </tr>
</table>

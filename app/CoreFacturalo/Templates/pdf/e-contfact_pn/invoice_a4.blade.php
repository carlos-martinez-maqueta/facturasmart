    ...
    <div class="information mt-3 borde_celeste1">
        <div class="div-table">
            ...
            <div class="div-table-row">
             ...
             <div class="div-table-row">
                <div class="div-table-col w-15 font-xs"><strong>Fecha vencimiento</div>
...
<table class="full-width mt-0 mb-0 borde_celeste1">   
        ...
        <tr class=""
            ...
            <th class="border-c_todo_dashed text-center py-2 desc" width="10%" style="color: white;">CANTIDAD</th>
...
<div class="font-xs">
 ...
 @if(in_array($document->document_type->id,['01','03']))
            ...
            @endif
<br><br>
Representación Impresa del <strong>COMPROBANTE ELECTRÓNICO</strong>, generado desde el Sistema del Contribuyente, para visualizar el documento visita: <strong> {!! url('/buscar') !!}</strong></td>

...
<table class="full-width">
    ...
    <tr>
        <td class="text-center pt-3 border-top"><h4> <strong>NOTA DE VENTA</h4></td>
    </tr>
    <tr>
        <td class="text-center pb-3 border-bottom"><h3> <strong>{{ $tittle }}</h3></td>
    </tr>
</table>
<table class="full-width">
    <tr>
        <td width="" class="pt-3"><p class="desc"> <strong>F. EMISIÓN:</p></td>
        <td width="" class="pt-3"><p class="desc">{{ $document->date_of_issue->format('Y-m-d') }}</p></td>
    </tr>


    <tr>
        <td class="align-top"><p class="desc"> <strong>Cliente:</p></td>
        <td><p class="desc">{{ $customer->name }}</p></td>
    </tr>
    <tr>
        <td><p class="desc"> <strong>{{ $customer->identity_document_type->description }}:</p></td>
    ...
    @if ($document->observation)
        <tr>
            <td><p class="desc"> <strong>OBSERVACIÓN:</p></td>
...
@if($payments->count())
<table class="full-width">
    <tr><td><strong>PAGOS EFECTUADOS:</strong> </td></tr>
    @php
        $payment = 0;
    @endphp

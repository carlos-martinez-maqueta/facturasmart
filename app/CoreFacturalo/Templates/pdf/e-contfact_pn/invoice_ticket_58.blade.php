...
<table class="full-width">
    ...
    <tr>
        <td class="text-center"><h5><strong>{{ 'N�. R.U.C. '.$company->number }}</h5></td>
    </tr>
    <tr>
    ...
    <tr>
        <td class="text-center ">{{  ($establishment->trade_address !== '-')? 'Den. Com.: '.$establishment->trade_address : ''  }}</td>
    </tr>
    @endisset
    <tr>
    ...
    <tr>
        <td class="text-center pt-3 border-top"><h5><strong>{{ $document->document_type->description }}</h5></td>
    </tr>
    <tr>
        <td class="text-center pb-3 border-bottom"><h5><strong>{{ $document_number }}</h5></td>
    </tr>
</table>
<table class="full-width">
    <tr>

...
<body>
    <table class="full-width" style="font-family: helvetica">
        ...
        <tr>
            <td class="text-center pb-2 border-bottom">
    ...
    <table class="full-width" style="font-family: helvetica">
        ...
        @if ($document->transport)
            ...
            @endphp
            <tr>
                <td class="desc text-uppercase">{{ $transport->identity_document_type->description }}</td>
                <td class="desc text-uppercase">{{ $transport->number_identity_document }}</td>
            </tr>
            <tr>
                <td class="desc text-uppercase">NOMBRE:</td>
                <td class="desc text-uppercase">{{ $transport->passenger_fullname }}</td>
            </tr>
            <tr>
                <td class="desc text-uppercase">N° ASIENTO</td>
                <td class="desc text-uppercase">{{ $transport->seat_number }}</td>
            </tr>
            <tr>
                <td class="desc text-uppercase">M. PASAJERO:</td>
                <td class="desc text-uppercase">{{ $transport->passenger_manifest }}</td>
            </tr>
            <tr>
                <td class="desc text-uppercase">F. INICIO:</td>
                <td class="desc text-uppercase">{{ $transport->start_date }}</td>
            </tr>
            <tr>
                <td class="desc text-uppercase">H. INICIO:</td>
                <td class="desc text-uppercase">{{ $transport->start_time }}</td>
            </tr>

            <tr>
                <td class="desc text-uppercase">AGENCIA ORIGEN:</td>
                <td class="desc text-uppercase">{{ $agency_origin }}</td>
            </tr>
            <tr>
                <td class="desc text-uppercase">U. ORIGEN:</td>
                <td class="desc text-uppercase">{{ $origin_district }}</td>
            </tr>
            <tr>
                <td class="desc text-uppercase">D. ORIGEN:</td>
                <td class="desc text-uppercase">{{ $transport->origin_address }}</td>
            </tr>
            <tr>
                <td class="desc text-uppercase">AGENCIA DESTINO:</td>
                <td class="desc text-uppercase">{{ $agency_destination }}</td>
            </tr>
            <tr>
                <td class="desc text-uppercase">U. DESTINO:</td>
                <td class="desc text-uppercase">{{ $destinatation_district }}</td>
            </tr>
            <tr>
                <td class="desc text-uppercase">D. DESTINO:</td>
                <td class="desc text-uppercase">{{ $transport->destinatation_address }}</td>
            </tr>
        @endif
        @if ($document->transport_dispatch)
            ...
            <tr>
                <td class="desc text-uppercase">{{ $sender_identity_document_type }}:</td>
                <td class="desc text-uppercase">{{ $transport_dispatch->sender_number_identity_document }}</td>
            </tr>
            <tr>
                <td class="desc text-uppercase">NOMBRE:</td>
                <td class="desc text-uppercase">{{ $transport_dispatch->sender_passenger_fullname }}</td>
            </tr>
            @if ($transport_dispatch->sender_telephone)
                <tr>
                    <td class="desc text-uppercase">TELF:</td>
                    <td class="desc text-uppercase">{{ $transport_dispatch->sender_telephone }}</td>
                </tr>
            @endif
            @if ($agency_origin_dispatch != '-')
                <tr>
                    <td class="desc text-uppercase">AGENCIA:</td>
                    <td class="desc text-uppercase">{{ $agency_origin_dispatch }}</td>
                </tr>
            @endif
            <tr>
                <td class="desc text-uppercase">D. ORIGEN:</td>
                <td class="desc text-uppercase">{{ $transport_dispatch->origin_address }}</td>
            </tr>
            <tr>
                <td class="desc text-uppercase">U. ORIGEN:</td>
                <td class="desc text-uppercase">{{ $origin_district_dispatch }}</td>
            </tr>
            <tr>
                <td colspan="2">DESTINATARIO</td>
            </tr>
            <tr>
                <td class="desc text-uppercase">{{ $recipient_identity_document_type }}:</td>
                <td class="desc text-uppercase">{{ $transport_dispatch->recipient_number_identity_document }}
                </td>
            </tr>
            <tr>
                <td class="desc text-uppercase">NOMBRE:</td>
                <td class="desc text-uppercase">{{ $transport_dispatch->recipient_passenger_fullname }}</td>
            </tr>
            @if ($transport_dispatch->recipient_telephone)
                <tr>
                    <td class="desc text-uppercase">TELF:</td>
                    <td class="desc text-uppercase">{{ $transport_dispatch->recipient_telephone }}</td>
                </tr>
            @endif
            @if ($agency_destination_dispatch != '-')
                <tr>
                    <td class="desc text-uppercase">AGENCIA:</td>
                    <td class="desc text-uppercase">{{ $agency_destination_dispatch }}</td>
                </tr>
            @endif
            <tr>
                <td class="desc text-uppercase">D. DESTINO:</td>
                <td class="desc text-uppercase">{{ $transport_dispatch->destinatation_address }}</td>
            </tr>
            <tr>
                <td class="desc text-uppercase">U. DESTINO:</td>
                <td class="desc text-uppercase">{{ $destination_district_dispatch }}</td>
            </tr>
        @endif
        @if ($document->reference_data)
            <tr>
                <td class="align-top">
                    <p class="desc-ticket text-uppercase">D. Referencia:</p>
                </td>
                <td>
        ...
        @if ($document->detraction)
            <tr>
                <td class="align-top">
                    <p class="desc-ticket text-uppercase">N. Cta detracciones:</p>
                </td>
                <td>
                    <p class="desc-ticket text-uppercase">{{ $document->detraction->bank_account }}</p>
                </td>
            </tr>
            <tr>
                <td class="align-top">
                    <p class="desc-ticket text-uppercase">B/S Sujeto a detracción:</p>
                </td>
                @inject('detractionType', 'App\Services\DetractionTypeService')
                <td>
                    <p class="desc-ticket text-uppercase">{{ $document->detraction->detraction_type_id }}
                        -
            ...
            <tr>
                <td class="align-top">
                    <p class="desc-ticket text-uppercase">Método de Pago:</p>
                </td>
                <td>
                    <p class="desc-ticket text-uppercase">
            ...
            <tr>
                <td class="align-top">
                    <p class="desc-ticket text-uppercase">Porcentaje detracción:</p>
                </td>
                <td>
                    <p class="desc-ticket text-uppercase">{{ $document->detraction->percentage }}%</p>
                </td>
            </tr>
            <tr>
                <td class="align-top">
                    <p class="desc-ticket text-uppercase">Monto detracción:</p>
                </td>
                <td>
                    <p class="desc-ticket text-uppercase">S/ {{ $document->detraction->amount }}</p>
                </td>
            </tr>
            @if ($document->detraction->pay_constancy)
                <tr>
                    <td class="align-top">
                        <p class="desc-ticket text-uppercase">Constancia de Pago:</p>
                    </td>
                    <td>
                        <p class="desc-ticket text-uppercase">{{ $document->detraction->pay_constancy }}</p>
                    </td>
                </tr>
            @endif
            ...
            @if ($invoice->operation_type_id == '1004')
                ...
                <tr>
                    <td class="align-top">
                        <p class="desc-ticket text-uppercase">Ubigeo origen:</p>
                    </td>
                    <td>
                        <p class="desc-ticket text-uppercase">{{ $document->detraction->origin_location_id[2] }}</p>
                    </td>
                </tr>
                <tr>
                    <td class="align-top">
                        <p class="desc-ticket text-uppercase">Dirección origen:
                    </td>
                    <td>
                        <p class="desc-ticket text-uppercase">{{ $document->detraction->origin_address }}
                    </td>
                </tr>
                <tr>
                    <td class="align-top">
                        <p class="desc-ticket text-uppercase">Ubigeo destino:</p>
                    </td>
                    <td>
                        <p class="desc-ticket text-uppercase">{{ $document->detraction->delivery_location_id[2] }}</p>
                    </td>
                </tr>
                <tr>

                    <td class="align-top">
                        <p class="desc-ticket text-uppercase">Dirección destino:</p>
                    </td>
                    <td>
                        <p class="desc-ticket text-uppercase">{{ $document->detraction->delivery_address }}</p>
                    </td>
                </tr>
                <tr>
                    <td class="align-top">
                        <p class="desc-ticket text-uppercase">Valor referencial servicio de
                            transporte:</p>
                    </td>
                    <td>
                        <p class="desc-ticket text-uppercase">{{ $document->detraction->reference_value_service }}</p>
                    </td>
                </tr>
                <tr>

                    <td class="align-top">
                        <p class="desc-ticket text-uppercase">Valor referencia carga efectiva:</p>
                    </td>
                    <td>
                        <p class="desc-ticket text-uppercase">
                            {{ $document->detraction->reference_value_effective_load }}</p>
                    </td>
                </tr>
                <tr>
                    <td class="align-top">
                        <p class="desc-ticket text-uppercase">Valor referencial carga útil:</p>
                    </td>
                    <td>
                        <p class="desc-ticket text-uppercase">{{ $document->detraction->reference_value_payload }}</p>
                    </td>
                </tr>
                <tr>
                    <td class="align-top">
                        <p class="desc-ticket text-uppercase">Detalle del viaje:</p>
                    </td>
                    <td>
                        <p class="desc-ticket text-uppercase">{{ $document->detraction->trip_detail }}</p>
                    </td>
                </tr>
            @endif
        ...
        @if ($document->retention)
            ...
            <tr>
                <td>
                    <p class="desc-ticket text-uppercase">Base imponible: </p>
                </td>
                <td>
                    <p class="desc-ticket text-uppercase">{{ $document->currency_type->symbol }}
                        {{ $document->retention->base }} </p>
                </td>
            </tr>
            <tr>
                <td>
                    <p class="desc-ticket text-uppercase">Porcentaje:</p>
                </td>
                <td>
                    <p class="desc-ticket text-uppercase">{{ $document->retention->percentage * 100 }}%</p>
                </td>
            </tr>
            <tr>
                <td>
                    <p class="desc-ticket text-uppercase">Monto:</p>
                </td>
                <td>
                    <p class="desc-ticket text-uppercase">{{ $document->currency_type->symbol }}
                        {{ $document->retention->amount }}</p>
                </td>
            </tr>
        @endif
        ...
        @if ($document->purchase_order)
            <tr>
                <td>
                    <p class="desc-ticket text-uppercase">Orden de compra:</p>
                </td>
                <td>
                    <p class="desc-ticket text-uppercase">{{ $document->purchase_order }}</p>
                </td>
            </tr>
        @endif
        @if ($document->quotation_id)
            <tr>
                <td>
                    <p class="desc-ticket text-uppercase">Cotización:</p>
                </td>
                <td>
                    <p class="desc-ticket text-uppercase">{{ $document->quotation->identifier }}</p>
                </td>
            </tr>
        @endif
        @isset($document->quotation->delivery_date)
            <tr>
                <td>
                    <p class="desc-ticket text-uppercase">F. Entrega</p>
                </td>
                <td>
                    <p class="desc-ticket text-uppercase">
        ...
        @isset($document->quotation->sale_opportunity)
            <tr>
                <td>
                    <p class="desc-ticket text-uppercase">O. Venta</p>
                </td>
                <td>
                    <p class="desc-ticket text-uppercase">{{ $document->quotation->sale_opportunity->number_full }}</p>
                </td>
            </tr>
        @endisset
    </table>
        ...
        <tbody>
            ...
            @foreach ($document->items as $row)
                <tr>
                    ...
                    <td class="text-left desc align-top">{{ symbol_or_code($row->item->unit_type_id) }}</td>
                    ...
                    <td class="text-right desc align-top" style="padding-right:5px;">
            ...
            @if ($document->total_exportation > 0)
                <tr>
                    ...
                    <td colspan="2" class="text-right desc-ticket text-uppercase">
    ...
    <table class="full-width" style="font-family: helvetica">
        ...
        <tr>
            @if ($row->code == '1000')
                <td class="desc-ticket text-uppercase">Son: <span class="text-uppercase">{{ $row->value }}
    ...
    @else
        ...
        @if ($document_description)
            <tr>
                <td class="text-center desc">Representación impresa de la {{ $document_description }} <br />Esta
                    puede

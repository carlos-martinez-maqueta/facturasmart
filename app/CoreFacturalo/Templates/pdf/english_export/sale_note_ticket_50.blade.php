...
<br>
<table class="full-width">
    <tr><td class="desc"><strong>Payments:</strong> </td></tr>
    @php
        $payment = 0;
    @endphp
    @foreach($payments as $row)
        ...
        @endphp
    @endforeach
    <tr><td class="desc"><strong>BALANCE:</strong> {{ $document->currency_type->symbol }} {{ number_format($document->total - $payment, 2) }}</td></tr>
</table>
@endif
@if ($document->terms_condition)
    ...
    <table class="full-width">
        <tr>
            <td class="desc">
                <h6 style="font-weight: bold;">Terms and conditions of the service</h6>

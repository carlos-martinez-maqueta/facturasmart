...
<body>
    ...
    <table class="full-width">
        ...
        <tr>
            <td>
                <p class="desc-9">Contacto:</p>
            </td>
            <td>
                <p class="desc-9">{{$document->person->contact->full_name}}, telf.: {{$document->person->contact->phone}} </p>
            </td>
        </tr>
        @endif
        ...
        <tr>
            <td>
                <p class="desc-9">Zona:</p>
            </td>
            <td>
                <p class="desc-9">{{\App\CoreFacturalo\Helpers\Template\TemplateHelper::getZoneById($document->person->zone_id) }}
            </td>
        </tr>
        @endif
    </table>

...
<body class="ticket">
    ...
    <table class="full-width">
        ...
        <tr>
            <td class="text-center font-bold">{{ $document->document_type->description }}</td>
        </tr>
        <tr>
            <td class="text-center font-bold">{{ $document_number }}</td>
        </tr>
    </table>
    <table class="full-width">
        <tr>
        ...
        <tr>
            <td class="align-top" colspan="2">
                Cliente:<span class="text-uppercase"><b>{{ $customer->name }}</b></span>
            </td>
        </tr>
        <tr>
            <td colspan="2">
                {{ $customer->identity_document_type->description }}:<span class="" text-uppercase><b>{{ $customer->number }}</b></span>
            </td>
        </tr>
        @if ($customer->address !== '')
        <tr>
    ...
    <table class="full-width mt-10 mb-10">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-right desc-9 align-top font-bold">{{ number_format($row->unit_price, 2) }}</td>

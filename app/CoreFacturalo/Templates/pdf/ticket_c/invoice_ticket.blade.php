...
<body class="ticket">
    ...
    <table class="full-width">
        <tr>
            ...
            <td width="" class="pt-3">
                <p class="">{{ $document->date_of_issue->format('Y-m-d') }}</p>
            </td>
        </tr>
        <tr>
            <td width="">
            ...
            <td width="">
                <p class="">{{ $document->time_of_issue }}</p>
            </td>
        </tr>
        @isset($invoice->date_of_due)
        <tr>
            <td>
                <p class="">F. Vencimiento:</p>
            </td>
            <td>
                <p class="">{{ $invoice->date_of_due->format('Y-m-d') }}</p>
            </td>
        </tr>
        @endisset
        ...
        <tr>
            ...
            <td>
                <p class="text-uppercase"><b>{{ $customer->name }}</b></p>
            </td>
        </tr>
        <tr>
            <td>
                <p class="">{{ $customer->identity_document_type->description }}:</p>
            </td>
            <td>
                <p class="" text-uppercase><b>{{ $customer->number }}</b></p>
            </td>
        </tr>
        @if ($customer->address !== '')
        <tr>
        ...
        <tr>
            ...
            <td>
                <p class="desc">{{$document->detraction->detraction_type_id}} - {{ $detractionType->getDetractionTypeDescription($document->detraction->detraction_type_id ) }}</p>
            </td>
        </tr>
        <tr>
            <td class="align-top">
    ...
    <table class="full-width mt-10 mb-10">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="font-size:11px;" class="text-left align-top font-bold">
                ...
                <td style="font-size:11px;" class="text-right align-top font-bold">{{ number_format($row->unit_price, 2) }}</td>
    ...
    <table class="full-width">
        ...
        <tr>
            <td colspan="2" class="text-center desc pt-2">Representación impresa del Comprobante de Pago Electrónico. <br/>Esta puede ser consultada en <a href="{!! route('search.index', ['external_id' => $document->external_id]) !!}" style="text-decoration: none; font-weight: bold;color:black;">{!! url('/buscar') !!}</a></td>
        </tr>
    </table>
    <table class="full-width">

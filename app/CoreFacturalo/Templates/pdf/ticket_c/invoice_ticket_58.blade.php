...
<table class="full-width">
    <tr >
        <td width="" class="pt-3"><p class="">F. Emisión:</p></td>
        <td width="" class="pt-3"><p class="">{{ $document->date_of_issue->format('Y-m-d') }}</p></td>
    </tr>
    <tr>
        <td width="" ><p class="">H. Emisión:</p></td>
        <td width="" ><p class="">{{ $document->time_of_issue }}</p></td>
    </tr>
    @isset($invoice->date_of_due)
    <tr>
        <td><p class="">F. Vencimiento:</p></td>
        <td><p class="">{{ $invoice->date_of_due->format('Y-m-d') }}</p></td>
    </tr>
    @endisset

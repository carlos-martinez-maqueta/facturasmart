...
<html>
<head>
    {{--<title>DE: {{ $document_number }}</title>--}}
...
<table class="full-width mt-0 mb-0 borde_celeste1">
        ...
        <tr class=""
            ...
            <th class="border-c_todo_dashed text-center py-1 desc" width="5%" style="color: white;">I T E M</th>
...
@endif
<br><br>
Representación Impresa del <strong>COMPROBANTE ELECTRONICO</strong>, generado desde el Sistema del Contribuyente.</td>
</body>
</html>

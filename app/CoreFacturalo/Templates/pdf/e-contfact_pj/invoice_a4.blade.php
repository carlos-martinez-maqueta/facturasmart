...
<div class="font-xs">
 ...
 @if(in_array($document->document_type->id,['01','03']))
            ...
            @endif
<br><br>
Representación Impresa del <strong>COMPROBANTE ELECTRÓNICO</strong>, ha sido emitido desde Sistema del Contribuyente, para visualizarlo visita: <strong> {!! url('/buscar') !!}</strong></td>

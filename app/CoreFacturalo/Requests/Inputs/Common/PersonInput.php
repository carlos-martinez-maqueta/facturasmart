...
class PersonInput
{
    public static function set($person_id, $address_id = null, $search_telephone = null)
    {
        ...
        return [
            ...
            'telephone' => ($customer_address) ? $customer_address->phone : $person->telephone, //$person->telephone,
            'perception_agent' => $person->perception_agent,
            'address_id' => $address_id,
            'internal_id' => $person->internal_code,

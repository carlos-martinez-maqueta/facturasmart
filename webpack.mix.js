...
mix.webpackConfig({
    resolve: {
        alias: {
            ...
            "@viewsModuleSurvey": path.resolve(
                __dirname,
                "modules/Survey/Resources/assets/js/views"
            ),
            ...
            ),        "@viewsModuleSeller": path.resolve(
                __dirname,
                "modules/Seller/Resources/assets/js/views"
            ),
            ...
            "@viewsModuleDashboard": path.resolve(
                __dirname,
                "modules/Dashboard/Resources/assets/js/views"
            ),

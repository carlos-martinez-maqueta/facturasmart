            ...
            <div class="card card-dashboard card-reports">
                <div class="card-body">
                    ...
                    <ul class="card-report-links">
                        ...
                        <li>
                            <a href="{{route('tenant.reports.seller_sales.index')}}">Ventas por Vendedor - Detallado - Consolidado</a>
                        </li>
                        @if($configuration->dispatchers_packers_document)
                        <li>
                            <a href="{{route('tenant.reports.packer_dispatcher_sales.index')}}">Ventas por Empaquetador - Repartidor</a>
                        </li>
                        @endif
                        <li>
                            <a href="{{route('tenant.reports.carrier_document_settlement.index')}}">Liquidación de documentos por transportista</a>
                        </li>
                        <li>
                            <a href="{{route('tenant.reports.carrier_document.index')}}">Transporte acumulado por transportista</a>
                        </li>
                        <li>
                            <a href="{{route('tenant.reports.sales_sabana.index')}}">Reporte de venta (sabana)</a>
                        </li>
                        <li>

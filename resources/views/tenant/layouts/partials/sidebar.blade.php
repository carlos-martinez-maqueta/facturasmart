...
<div class="menu-container flex-grow-1">
    <ul id="menu" class="menu">
        ...
        @if (in_array('whatsapp', $vc_modules))
            ...
            @endif
        @endif
        @if (in_array('surveys', $vc_modules))
            <li class="mega">
                <a href="#survey" data-bs-toggle="collapse" data-role="button"
                    aria-expanded="{{ $firstLevel === 'survey' ? true : false }}{{ $firstLevel === 'questions' ? true : false }}{{ $firstLevel === 'answers' ? true : false }}"
                    class="{{ $firstLevel === 'survey' ? 'active' : '' }}{{ $firstLevel === 'questions' ? 'active' : '' }}{{ $firstLevel === 'answers' ? 'active' : '' }}"
                    data-clicked="{{ $firstLevel === 'survey' ? true : false }}{{ $firstLevel === 'questions' ? true : false }}{{ $firstLevel === 'answers' ? true : false }}">
                ...
                <ul id="survey">
                    <li>
                        <a href="{{ route('survey.index') }}"
                            class="{{ $firstLevel === 'survey' && $secondLevel == null ? 'active' : '' }}">
                    ...
                    <li>
                        <a href="{{ route('survey.respondet.index') }}"
                            class="{{ $firstLevel === 'survey' && $secondLevel == 'respondet' ? 'active' : '' }}">
        ...
        @if (in_array('documents', $vc_modules))
            <li class="mega">
                ...
                <ul id="ventas"
                    class="collapse {{ $firstLevel === 'documents' ? 'show' : '' }}{{ $firstLevel === 'summaries' ? 'show' : '' }}{{ $firstLevel === 'voided' ? 'show' : '' }}{{ $firstLevel === 'quotations' ? 'show' : '' }}{{ $firstLevel === 'sale-notes' ? 'show' : '' }}{{ $firstLevel === 'contingencies' ? 'show' : '' }}{{ $firstLevel === 'incentives' ? 'show' : '' }}{{ $firstLevel === 'order-notes' ? 'show' : '' }}{{ $firstLevel === 'sale-opportunities' ? 'show' : '' }}{{ $firstLevel === 'contracts' ? 'show' : '' }}{{ $firstLevel === 'production-orders' ? 'show' : '' }}{{ $firstLevel === 'technical-services' ? 'show' : '' }}{{ $firstLevel === 'user-commissions' ? 'show' : '' }}{{ $firstLevel === 'regularize-shipping' ? 'show' : '' }}{{ $firstLevel === 'seller' ? 'show' : '' }}">
                    ...
                    @if ($is_integrate_system)
                        @if (in_array('production_orders', $vc_module_levels))
                            <li class="mega">
                                <a href="#production_orders" data-toggle="collapse"
                                    class="{{ in_array($firstLevel, ['production-order', 'inventory-review']) ? 'active' : '' }}"
                                    aria-expanded="{{ in_array($firstLevel, ['production-order', 'inventory-review']) ? 'active' : '' }}">
                                ...
                                <ul id="production_orders"
                                    ...
                                    <li class="{{ $firstLevel === 'inventory-review' ? 'nav-active' : '' }}">
                                        <a class="nav-link"
                                            href="{{ route('tenant.production_order.index_inventory') }}">
                        ...
                        @if (in_array('dispatch_orders', $vc_module_levels))
                            <li class="mega">
                                <a href="#production_orders" data-toggle="collapse"
                                    class="{{ in_array($firstLevel, ['dispatch-order']) ? 'active' : '' }}"
                                    aria-expanded="{{ in_array($firstLevel, ['dispatch-order']) ? 'active' : '' }}">
                                    <i data-cs-icon="book-open" class="icon" data-cs-size="18"></i>
                                    <span class="label">Ordenes de despacho</span>

                                </a>
                                <ul id="production_orders"
                                    class="collapse {{ in_array($firstLevel, ['dispatch-order']) ? 'show' : '' }}"
                                    data-parent="#accordionExample">
                                    <li>
                                        <a class="{{ $firstLevel === 'dispatch-order' && !$secondLevel ? 'active' : '' }}"
                                            href="{{ route('tenant.dispatch_order.index') }}">Lista</a>
                                    </li>
                                    <li
                                        class="{{ $firstLevel === 'dispatch-order' && $secondLevel == 'list' ? 'nav-active' : '' }}">
                                        <a class="nav-link" href="{{ route('tenant.dispatch_order.index_list') }}">
                                            <span class="label">Ruta lima
                                            </span></a>
                                    </li>
                    ...
                    @if (in_array('incentives', $vc_module_levels))
                        <li class="mega">
                            <a href="#incentives" data-bs-toggle="collapse" data-role="button"
                                aria-expanded="{{ $firstLevel === 'user-commissions' ? true : false }}{{ $firstLevel === 'incentives' ? true : false }}{{ $firstLevel === 'seller' ? true : false }}"
                                class="{{ $firstLevel === 'user-commissions' ? 'active' : '' }}{{ $firstLevel === 'incentives' ? 'active' : '' }}{{ $firstLevel === 'seller' ? 'active' : '' }}"
                                data-clicked="{{ $firstLevel === 'user-commissions' ? true : false }}{{ $firstLevel === 'incentives' ? true : false }}{{ $firstLevel === 'seller' ? true : false }}">
                            ...
                            <ul id="incentives"
                                ...
                                <li>
                                    <a class="{{ $firstLevel === 'seller' && $secondLevel === 'monthly-sales' ? 'active' : '' }}"
                                        href="{{ route('tenant.seller.monthly-sales') }}">Ventas mensuales</a>
                                </li>
                                <li>
        ...
        @endif
        {{-- <li class="mega">
            <a href="#seller" data-bs-toggle="collapse" data-role="button"
                aria-expanded="{{ $firstLevel === 'seller' ? true : false }}"
                class="{{ $firstLevel === 'seller' ? 'active' : '' }}"
                data-clicked="{{ $firstLevel === 'seller' ? true : false }}">
                <i data-cs-icon="file-text" class="icon" data-cs-size="18"></i>
        ...
        @if ($configuration->export_mall)
            <li class="mega">
                <a class="{{ $firstLevel === 'mall' ? 'active' : '' }}" href="{{ route('tenant.mall.index') }}">
                    <i data-cs-icon="file-text" class="icon" data-cs-size="18"></i>
                ...
                <li class="mega">
                    ...
                    <ul id="pos"
                        ...
                        @if ($configuration->pos_bottles)
                            <li>
                                <a class="{{ $firstLevel === 'warranty_document' ? 'active' : '' }}"
                                    href="{{ route('tenant.warranty_document.index') }}">Botellas <span
                                        style="font-size:.65rem;"></span></a>
                            </li>

                            <li>
                                <a class="{{ $firstLevel === 'warranty_document' ? 'active' : '' }}"
                                    href="{{ route('tenant.warranty_document.report_index') }}">Reporte Botellas
                                    <span style="font-size:.65rem;"></span></a>
                            </li>
                        @endif
                        @if (in_array('advances_customers', $vc_module_levels))
                            <li>
                        ...
                        @endif
                        @if (in_array('advances_suppliers', $vc_module_levels))
                            <li>
        ...
        @if (in_array('ecommerce', $vc_modules))
            <li class="mega">
                ...
                <ul id="tienda"
                    ...
                    @endif
                    <li>
                        <a class="{{ $firstLevel === 'store' && $secondLevel === 'users' ? 'active' : '' }}"
            ...
            <li class="mega">
                ...
                <ul id="customers"
                    ...
                    @if ($configuration->dispatchers_packers_document)
                        <li>
                            <a class="{{ $firstLevel === 'person-packers' ? 'active' : '' }}"
                                href="{{ route('tenant.person_packers.index') }}">
                                <span class="label"> Empacadores </span>
                            </a>
                        </li>
                        <li>
                            <a class="{{ $firstLevel === 'person-dispatchers' ? 'active' : '' }}"
        ...
        @endif
        @if (in_array('reservation', $vc_modules))
            <li class="mega">
                <a href="#reservation" data-toggle="collapse" data-role="button"
                    data-active="{{ $firstLevel === 'canchas' ? true : false }}"
                    aria-expanded="{{ $firstLevel === 'canchas' ? true : false }}"
                    class="{{ $firstLevel === 'canchas' ? 'active' : '' }}"
                    data-clicked="{{ $firstLevel === 'canchas' ? true : false }}">
                    <i class="fa fa-quote-right icon" data-cs-size="18" style="margin-right: 10px;"></i>
                    <span class="label">Reservaciones</span>
                </a>

                <ul id="reservation">
                    <li>
                        <a class="{{ $firstLevel === 'canchas' && $secondLevel === null ? 'active' : '' }}"
                            href="{{ route('tenant.canchas.index') }}">
                            <span class="label">Lista</span>
                        </a>
                    </li>
                    <li>
                        <a class="{{ $firstLevel === 'canchas' && $secondLevel === 'types' ? 'active' : '' }}"
        ...
        @if (in_array('restaurant_app', $vc_modules))
            <li class="mega">
                <a class="{{ $firstLevel === 'comanda' && $secondLevel === 'restaurantes' ? 'active' : '' }}"
                    href="{{ route('tenant.comanda.index') }}">
                    <i class="fa fa-utensils icon" data-cs-size="18" style="margin-right: 10px;"></i>
        ...
        @if (in_array('cuenta', $vc_modules))
            <!-- <li class="mega">
                <a href="#cuenta" data-bs-toggle="collapse" data-role="button"
                    ...
                    <span class="label">Mis pagoss</span>
...
@endif
        ...
        <li>
            <a href="{{ route('tenant.exchange_currency.index') }}"
                class="{{ $firstLevel === 'exchange_currency' ? 'active' : '' }}">
                <i data-cs-icon="money" class="icon" data-cs-size="18"></i>
        ...
        <li class="mega">
            <a href="{{ route('tenant.payment.index') }}"
                class="{{ $firstLevel === 'cuenta' && $secondLevel === 'payment_index' ? 'active' : '' }}">
                <i data-cs-icon="money" class="icon" data-cs-size="18"></i>

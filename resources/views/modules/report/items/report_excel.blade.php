            ...
            <table class="">
                ...
                @foreach($records as $key => $value)
                    ...
                    if($type === 'purchase'){
                        ...
                        $customer_department = $document->customer->department->description;
                        $customer_province = $document->customer->province->description;
                        $customer_district = $document->customer->district->description;
                    }
                    ?>
                    ...
                    <tr>
                        ...
                        <td class="celda">{{$customer_department}}</td>
                        <td class="celda">{{$customer_province}}</td>
                        <td class="celda">{{$customer_district}}</td>
                        @if($type !== 'purchase')

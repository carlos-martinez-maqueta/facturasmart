...
<div class="container">
    <div class="card mt-4">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <a href="{{ route('tenant.reports.customers.export', ['start_date' => request('start_date'), 'end_date' => request('end_date')]) }}" class="el-button submit el-button--success el-button--small"><i class="fa fa-file-excel"></i> Exportar a Excel</a>
        </div>
        <div class="card-body">
            <div id="app">
                <top-customers-report :url="'{{ route('tenant.reports.customers.top') }}'"></top-customers-report>
            </div>

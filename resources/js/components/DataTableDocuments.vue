        ...
        <div class="row">
            <div class="col-md-12 col-lg-12 col-xl-12">
                ...
                <div class="row mt-2" v-if="see_more">
                    ...
                    <div class="row" v-if="optionsZone.length > 0">
                    ...
                    >
                        ...
                        <el-button
                            ...
                            class="submit"
                            type="success"
                            @click.prevent="exportConcar"
                            icon="el-icon-download"
                            >Exportar Concar</el-button
                        >
                    </div>
                </div>
...
export default {
    ...
    async mounted() {
        await this.$http
            ...
            .then((response) => {
                ...
                if(this.departments && this.provinces){
                    this.createOptionsZone();
                }
            });
        if (this.to_anulate) {
            this.search.state_type_id = 13;
        }
    ...
    exportConcar(){
        let url = `/${this.resource}/concar?${this.getQueryParameters()}`
        window.open(url, '_blank');
    },
        handleChangeZone(value) {
            // console.log("🚀 ~ handleChangeZone ~ value:", value);
        },
        createOptionsZone() {
        ...
        getTotalRecords() {
            ...
            return this.$http
                .get(
                    `/${
                        this.resource
                    }/recordsTotal?${this.getQueryParameters()}`
                )
                .then((response) => {
        ...
        getQueryParameters() {
            return queryString.stringify({
                ...
                limit: this.limit,
                ...this.search,
                ubigeo: this.search.ubigeo
                    ? this.search.ubigeo.join(",")
                    : null,
            });
        },
        changeClearInput() {

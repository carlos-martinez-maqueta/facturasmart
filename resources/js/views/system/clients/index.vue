            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-3 col-sm-12 pb-2">
                        ...
                        >
                            <el-option
                                v-for="(label, idx) in columnsSearch"
                                :key="idx"
                                :value="label.value"
                                :label="label.label"
                            ></el-option>
                    ...
                    <table class="table table-hover">
                        <thead>
                            <tr>
                                ...
                                <th
                                    v-if="columns.telephone.visible"
                                    scope="col"
                                >
                                    Teléfono
                                </th>
                        ...
                        <tbody>
                            <template v-for="(row, index) in records">
                                <tr :key="index">
                                    ...
                                    <td
                                        v-if="
                                            columns.start_billing_cycle.visible
                                        "
                                        class="text-center"
                                    >
                                        <template
                                            v-if="row.start_billing_cycle"
                                        >
                                            <span></span>
                                            <span>{{
                                    ...
                                    <td
                                        v-if="
                                            columns.count_establishments.visible
                                        "
                                        class="text-center"
                                    >
                                    ...
                                    <td
                                        v-if="
                                            columns.monthly_sales_total.visible
                                        "
                                        class="text-center"
                                    >
                                        <data-limit-notification
                                    ...
                                    <td
                                        v-if="
                                            columns.queries_to_apiperu.visible
                                        "
                                    >
                                ...
                                >
                                    ...
                                    <td
                                        v-if="
                                            columns.max_establishments.visible
                                        "
                                        class="text-center"
                                    >
                                        <el-switch
                                ...
                                <tr :key="`${index}c`">
                                    <td :colspan="7">
                                        ...
                                        <template v-else>
                                            <a
                                                href="#"
                                                @click.prevent="addComment(row)"
                                            >
                                                Agregar comentario
                                            </a>
                                        </template>
                                    </td>
                                    <td :colspan="lengthColumns - 7"></td>
                                </tr>
                            </template>
                        </tbody>
                    </table>
...
export default {
    ...
    computed: {
        lengthColumns() {
            return (
                Object.keys(this.columns).filter(
                    (column) => this.columns[column].visible
                ).length + 5
            );
        },
    },
    methods: {
        ...
        setComment(row) {
            ...
            this.timer = setTimeout(() => {
                ...
                this.$http
                    .post(`${this.resource}/set_comment`, form)
                    .then((response) => {
        ...
        setTelephone(row) {
            ...
            this.timer = setTimeout(() => {
                ...
                this.$http
                    .post(`${this.resource}/set_telephone`, form)
                    .then((response) => {
                        if (response.data.success) {
                            this.$message.success(response.data.message);
                        } else {
        ...
        setMonto(row) {
            ...
            this.timer = setTimeout(() => {
                ...
                this.$http
                    .post(`${this.resource}/set_monto`, form)
                    .then((response) => {
                        if (response.data.success) {
                            this.$message.success(response.data.message);
                        } else {
        ...
        setTiempo(row) {
            ...
            this.timer = setTimeout(() => {
                ...
                this.$http
                    .post(`${this.resource}/set_tiempo`, form)
                    .then((response) => {
                        if (response.data.success) {
                            this.$message.success(response.data.message);
                        } else {
        ...
        valid(row) {
            let { end_billing_cycle, locked } = row;
            if (!locked) {
                if (moment().isSameOrAfter(end_billing_cycle)) {
                    this.$message.error(
                        "No se puede desbloquear la cuenta, actualice o elimine la fecha de fin de ciclo de facturación."
                    );
                    let index = this.records.findIndex(
                        (record) => record.id === row.id
                    );
                    this.records[index].locked_tenant = true;
                    return false;
                }
                return true;
            }

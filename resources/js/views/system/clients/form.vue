        ...
        <form autocomplete="off" @submit.prevent="submit">
            <div class="form-body">
                ...
                <div class="row mb-3">
                    ...
                    <div v-if="!form.is_update" class="col-md-3">
                        <div
                    ...
                    <div
                        v-if="form.is_rus && !recordId"
                        class="col-md-5 center-el-checkbox"
                    >
                        <div
                    ...
                    <div class="col-md-4">
                        <div
                            :class="{ 'has-danger': errors.users }"
                            class="form-group"
                        >
                            <label class="control-label">Usuario</label>
                            <el-input v-model="form.users" dusk="name">
                            </el-input>
                            <small
                                v-if="errors.users"
                                class="text-danger"
                                v-text="errors.users[0]"
                            >
                            </small>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div
                            :class="{ 'has-danger': errors.password_sunat }"
                            class="form-group"
                        >
                            <label class="control-label">Clave</label>
                            <el-input v-model="form.password_sunat" dusk="name">
                            </el-input>
                            <small
                                v-if="errors.password_sunat"
                                class="text-danger"
                                v-text="errors.password_sunat[0]"
                            >
                            </small>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div
                            ...
                            class="form-group"
                        >
                            <label class="control-label">Password CDT</label>
                            <el-input v-model="form.password_cdt" dusk="name">
                            </el-input>
                            <small
                                v-if="errors.password_cdt"
                                class="text-danger"
                                v-text="errors.password_cdt[0]"
                            >
                            </small>
                        </div>
                    </div>
                    ...
                    <el-collapse-item name="2" title="Entorno del sistema">
                        ...
                        <template
                            v-if="
                                ...
                                (toggle == true && form.soap_type_id !== '03')
                            "
                        >
                            <div class="row">
                        ...
                        <br />
                        <div class="row" v-if="form.soap_type_id !== '03'">
                            <div class="col-md-4">
                                <div
                                    :class="{
                                        'has-danger':
                ...
                <div class="row">
                    ...
                    <!-- <div class="col-md-12 center-el-checkbox mt-4">
                        <div class="form-group">
                            <el-checkbox v-model="form.create_restaurant">
                                ¿ Crear cuenta de Usuario de Restaurante ?
                            </el-checkbox>
                            <br />
                        </div>
                    </div> -->
    ...
    methods: {
        ...
        beforeUpload(file) {
            if (this.isSmart) {
                ...
                if (file.name == "certificate_smart.pem") {
                    return true;
                } else {
                    this.$message({
                        type: "error",
        ...
        beforeUploadPem(file) {
            ...
            let pass = false;
            //valid  if file has the extension .pem
            if (file.name.split(".").pop() == "pem") {
                pass = true;
            } else {
                this.$message({
                    type: "error",
        ...
        FixAppChildren(currentObj, treeStatus) {
            ...
            if (currentObj !== undefined) {
                let selected = treeStatus.checkedKeys.indexOf(currentObj.id); // -1 is unchecked
                console.log("🚀 ~ FixAppChildren ~ selected:", selected);
                if (selected !== -1) {
                    this.SelectParent(currentObj, element);
                    this.FixSameValueToChild(currentObj, true, element);
                } else {
        ...
        FixSameValueToChild(treeList, isSelected, element) {
            ...
            if (treeList !== undefined && element !== undefined) {
                ...
                console.log("🚀 ~ FixSameValueToChild ~ isSelected:", isSelected)
                console.log("🚀 ~ FixSameValueToChild ~ treeList.id:", treeList.id)

                const modulesAndLevelsSelecteds =
        ...
        async submit() {
            ...
            let modulesAndLevelsSelectedsFiltered =
                modulesAndLevelsSelecteds.filter((m) => m.id == 30);

            console.log(
                "🚀 ~ submit ~ modulesAndLevelsSelecteds:",
                modulesAndLevelsSelectedsFiltered
            );
            ...
            console.log("🚀 ~ submit ~ modules:", JSON.stringify(modules))

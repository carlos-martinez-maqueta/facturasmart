            ...
            <div class="row d-flex align-items-end mb-1">
                <div class="col-4">
                    <div class="form-group">
                        ...
                        >
                            <template slot="prepend" style="px-1">{{
                ...
                <div class="col-3">
                    <div
                        :class="{ 'has-danger': difference < 0 }"
                        class="form-group"
                    >
                        <label
                            class="control-label mb-0"
                            v-text="difference < 0 ? 'Faltante' : 'Vuelto'"
                        ></label>
                ...
                <div class="col-12">
                    <div class="form-group">
                        <label class="control-label mb-0"
                            >Descuento ({{
                                discount_type === "01" ? "Monto" : "Porcentaje"
                            }})</label
                        >
                        <el-input
...
this.form.total_igv_free = _.round(total_igv_free, 2);
        ...
        checkPaymentGarage() {
            ...
            if (this.form.payments.length == 0) {
                this.$refs.componentMultiplePaymentGarage.clickAddPayment(
                    this.form.total
                );

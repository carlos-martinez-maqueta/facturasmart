    ...
    <div class="container-fluid p-0">
        ...
        >
            <div class="col-lg-7 col-md-6 px-4 hyo">
                ...
                <div v-if="place == 'cat2'" class="flex-container">
                ...
                <div v-if="place == 'prod' || place == 'cat2'" class="row">
                  ...
                  <button type="button" class="btn waves-effect waves-light btn-sm btn-success m-1__2" @click="clickHistoryPurchases(item.item_id)"><i class="fas fa-cart-plus"></i></button> -->
                    ...
                    <button type="button" style="width:100% !important;" slot="reference" class="btn btn-sm btn-default " @click="clickHistorySales(item.item_id)"><i class="fa fa-search"></i></button>
                  </el-popover> -->
                                    <!--<el-tooltip class="item" effect="dark" content="Visualizar stock" placement="bottom-end">
                    <button type="button" style="width:25% !important;"   class="btn btn-sm btn-primary-pos" @click="clickWarehouseDetail(item)">
                  ...
                  <el-tooltip class="item" effect="dark" content="Visualizar historial de ventas del producto (precio venta) y cliente" placement="bottom-end">
                    <button type="button" style="width:25% !important;"   class="btn btn-sm btn-primary-pos" @click="clickHistorySales(item.item_id)"><i class="fa fa-list"></i></button>
                  </el-tooltip>
                  ...
                  <el-tooltip class="item" effect="dark" content="Visualizar historial de compras del producto (precio compra)" placement="bottom-end">
                    <button type="button" style="width:25% !important;"  class="btn btn-sm btn-primary-pos" @click="clickHistoryPurchases(item.item_id)"><i class="fas fa-cart-plus"></i></button>
                  </el-tooltip>
                                            ...
                                            >
                                                ...
                                                >
                                                    <div
                                                        v-for="(
                                                            row, index
                                                        ) in getAffectationExoneratedIgv"
...
export default {
    ...
    methods: {
        handleFn123() {
                this.$refs.componentFastPaymentGarage.clickPayment();
        },
        handleKeydown(event) {
        ...
        async clickAddItem(item, index, input = false) {
            ...
            let exist_item = _.find(this.form.items, {
                ...
                console.log("🚀 ~ clickAddItem ~ exist_item:", exist_item)

                ...
                <div class="row">
                            ...
                            <div class="form-group" :class="{'has-danger': errors.code}">
                                <label class="control-label">Codigo
                                    <el-tooltip
                                        ...
                                        <div slot="content">
                                        <b>
                                            Para asegurar que los comprobantes electrónicos tengan valor legal,<br />
                                            el código de unidad de medida no debe ser ingresado de forma libre.<br />
                                            Es fundamental verificar que el código exista en el Catálogo No. 03: <br />
                                            Códigos de Tipo de Unidad de Medida Comercial de SUNAT. Usar un código<br />
                                            que no esté en este catálogo invalida los comprobantes emitidos,<br />
                                            ya que no cumplirían con los requisitos establecidos por la SUNAT.
                                        </b>
                                        </div>
                        ...
                        <div class="form-group" :class="{ 'has-danger': errors.id }">
                            <label class="control-label">Código
                                <el-tooltip
                                        ...
                                        <div slot="content">
                                        <b>
                                            Es un valor obligatorio y normado por SUNAT, que debe estar alineado con el <br />
                                            Catálogo No. 03 de SUNAT. Este código se utiliza en el archivo XML de los CPE <br /><br />
                                            Ejemplo:<br />
                                            Código: "NIU" (Código oficial para "Unidad").
                                        </b>
                                        </div>
                                        <i class="fa fa-info-circle"></i>
                                    </el-tooltip>
                    ...
                    <div class="col-md-2">
                        <div class="form-group" :class="{'has-danger': errors.symbol}">
                            <label class="control-label">Símbolo
                                <el-tooltip
                                        class="item"
                                        effect="dark"
                                        placement="top-start"
                                        ...
                                        <div slot="content">
                                        <b>
                                            Es la representación visible en la versión impresa (PDF) del comprobante.<br />
                                            Puede ser personalizado libremente por el usuario según su preferencia.<br /> <br />
                                            Ejemplo: <br />
                                            Símbolo: "UND" (el usuario elige para representar "Unidad" en el PDF).
                                        </b>
                                        </div>
                                        <i class="fa fa-info-circle"></i>
                                    </el-tooltip>

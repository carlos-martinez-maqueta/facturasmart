        ...
        <div class="card-body"> 
            <form autocomplete="off" @submit.prevent="submit">
                <div class="row pt-1">
                    ...
                    <div class="col-md-12 mt-3">
                        <div class="form-group" :class="{'has-danger': errors.gekawa_url}">
                            <label class="control-label">Url<span class="text-danger">*</span></label>
                            <el-input v-model="form.gekawa_url"></el-input>
                            <small class="text-danger" v-if="errors.gekawa_url" v-text="errors.gekawa_url[0]"></small>
                        </div>
                    </div>
                </div>

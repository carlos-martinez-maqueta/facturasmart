<template>
    <div class="card mb-0 pt-2 pt-md-0">
        <div class="card-header">
            <h3 class="my-0">Guía de Remisión Remitente</h3>
        </div>
        <div class="card-body">
            <form autocomplete="off" @submit.prevent="submit">
                <div class="form-body">
                    ...
                    <div class="row">
                        ...
                        <small class="text-danger" v-if="errors.container_number" v-text="errors.container_number[0]"></small>
                        </div>
                        </div>-->
                        <div class="col-lg-6">
                            <div
    ...
    mounted() {
        this.$http
            ...
            .then((response) => {
                ...
                this.is_integrate_system = response.data.is_integrate_system;
            ...
            .then(() => {
                ...
                this.form.origin.country_id =
                    this.document.establishment.country_id;
                ...
                this.form.delivery.country_id =
                    this.document.customer.country_id;
                ...
                if (this.dispatch) {
                    this.form.transfer_reason_description =
                        this.dispatch.transfer_reason_description;
                    ...
                    if (this.dispatch.secondary_license_plates) {
                        this.form.secondary_license_plates =
                            this.dispatch.secondary_license_plates;
                    }
                }
            })
            .then(() => {
    ...
    methods: {
        async changeCompany() {
            try {
                ...
                const response = await this.$http.get(
                    `/document/tables-company/${this.form.company_id}`
                );
        ...
        filterSeries() {
            ...
            this.series = _.filter(this.all_series, {
                ...
                console.log("🚀 ~ filterSeries ~ this.form.series_id:", this.form.series_id)
            this.form.series_id =

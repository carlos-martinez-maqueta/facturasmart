<template>
    ...
    >
        <div class="form-body">
            <div class="row">
                ...
                <div class="col-lg-3">
                    <div
                        class="form-group"
                        :class="{ 'has-danger': errors.weight }"
                    >
        ...
        <span slot="footer" class="dialog-footer">
            ...
            <el-button type="primary" @click="clickAddItem" v-if="form.item"
                >Agregar</el-button
            >
        </span>
...
export default {
    ...
    methods: {
        ...
        updateQW() {
            ...
            this.item.attributes.forEach((row) => {
                if (row.attribute_type_id == "5031") {
                    ...
                    console.log(
                        "🚀 ~ file: items.vue:122 ~ this.item.attributes.forEach ~ this.form.weight:",
                        this.form.weight
                    );
                }
            });
        ...
        create() {
            this.$http
                .post(
                    `/${this.resource}/tables?current_item=${
                        this.currentItem ? this.currentItem.item_id : ""
                    }`
                )
                .then((response) => {
                    ...
                    if (this.currentItem) {
                        ...
                        this.form.IdLoteSelected =
                            this.currentItem.IdLoteSelected;
                        this.item = this.items.find(
                            (it) => it.id == this.form.item
                        );
                    } else {
                        this.form.weight = 1;

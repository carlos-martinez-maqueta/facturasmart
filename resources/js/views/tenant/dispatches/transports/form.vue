                ...
                <div class="row">
                    <div class="col-md-6">
                        <div
                            ...
                            class="form-group"
                        >
                            <label class="control-label">Nro. de Placa
                                <el-tooltip
                                    class="item"
                                    effect="dark"
                                    content="Ingrese solo letras y números; no se permiten espacios ni guiones"
                                    placement="top"
                                >
...
export default {
    ...
    methods: {
        ...
        async submit() {
            ...
            if (this.form.secondary_plate_number == "") {
                this.form.secondary_plate_number = null;
            }
            ...
            if (
                ...
                this.$message.error(
                    "Debe ingresar al menos un número de placa"
                );
                return;
            }

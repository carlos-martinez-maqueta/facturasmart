            ...
            <form autocomplete="off" @submit.prevent="submit">
                <div class="form-body">
                    ...
                    <div class="row">
                        ...
                        <div
                            class="col-lg-4"
                            v-if="form.transfer_reason_type_id === '02'"
                        >
                            <div
                                :class="{
                        ...
                        <div class="col-lg-2">
                            <div
                                :class="{
                                    'has-danger': errors.inventory_reference_id,
                                }"
                                class="form-group"
                            >
                                ...
                                <small
                                    v-if="errors.inventory_reference_id"
                                    class="text-danger"
                                    v-text="errors.inventory_reference_id[0]"
                                ></small>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            ...
                            >
                                <div slot="content">
                                    <b>
                                        Al activar esta opción, se permite
                                        emitir guías de remisión sin
                                        necesidad<br />
                                        de identificar al chofer o la placa del
                                        vehículo.<br />
                                        <br />

                                        M1: Son vehículos con 8 asientos o
                                        menos, sin incluir el asiento del
                                        conductor.<br />
                                        Ejemplos de vehículos M1 incluyen
                                        automóviles, SUVs, y camionetas
                                        pequeñas.<br />
                                        <br />

                                        L: Se refiere a vehículos con 2 a 3
                                        ruedas, como motocicletas y
                                        mototaxis.<br />
                                        Ejemplos de vehículos L incluyen motos
                                        lineales, scooters, y mototaxis.
                                    </b>
                                </div>
                                <i class="fa fa-info-circle"></i>
                            </el-tooltip>
                            <el-checkbox
                                label="Traslado en vehículos de categoría M1 o L"
                                v-model="form.is_transport_category_m1l"
                            ></el-checkbox>
                        </div>
                    </div>
                    <div class="row"></div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            >
                                ...
                                >
                                    <el-option
                                        v-for="option in origin_addresses"
                                        :key="option.id"
                    ...
                    <div class="row">
                        <div
                            ...
                            v-if="form.is_transport_category_m1l"
                        >
                        ...
                        <template
                            v-if="
                                form.transport_mode_type_id === '01' &&
                                !form.is_transport_category_m1l
                            "
                        >
                            <div class="col-lg-6">
                        ...
                        <!-- <template v-if="form.transport_mode_type_id === '02' && !form.is_transport_category_m1l"> -->
                        <template
    ...
    methods: {
        ...
        initForm() {
            ...
            this.form = {
                ...
                is_transport_category_m1l: false,
                plate_number: null,
        ...
        async changeEstablishment() {
            if (this.form.establishment_id) {
                ...
                console.log(
                    "🚀 ~ changeEstablishment ~ this.series:",
                    this.series
                );
        ...
        setDefaultSeries() {
            let series_id = parseInt(this.series_default);
        ...
        async submit() {
            ...
            if (this.form.transport_mode_type_id === "02") {
                ...
                if (this.form.is_transport_category_m1l) {
                    this.form.driver_id = null;
                    this.form.driver = null;
                    this.form.transport_ids = [];
                    if (!this.form.delivery_address_id) {
                        return this.$message.error(
                            "El punto de llegada es requerido"
                        );
                    }
                    // if (this.form.transport_ids.length > 1) {
                    //     return this.$message.error('Es requerido solo un vehículo')
                    // }
                } else {
                    this.form.plate_number = null;

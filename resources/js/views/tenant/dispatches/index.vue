                        ...
                        <th>Estado
                            <el-tooltip
                                ...
                                >
                                    <div slot="content">
                                    <b>
                                        - Registrado: el comprobante se creó sin valor legal y solo puede ser aceptado el mismo día.<br />
                                        ...
                                        - Anulado: el proceso debe hacerse desde el portal web de Sunat el mismo día de su emisión.<br />
                        ...
                        <td class="text-center">
                            ...
                            <template v-if="row.is_pse && row.btn_is_tesla">
                                ...
                                <a
                                    ...
                                    v-if="row.state_type_id == '01' || row.state_type_id == '09'"
                                    >Editar</a
                                >
                            </template>
                            <template v-else>
                            ...
                            <!-- <button
                                type="button"
                                class="btn waves-effect waves-light btn-sm btn-info"
                                @click.prevent="jsonPse(row.id)"
                                v-if="row.btn_is_tesla"
                            >
                                Json PSE
                            </button> -->
                        </td>

        ...
        <div class="page-header pr-0">
            ...
            <div class="right-wrapper pull-right">
                ...
                <button
                    type="button"
                    class="btn btn-custom btn-sm mt-2 mr-2"
                    @click.prevent="clickReplace"
                >
                    <i class="fa fa-plus-circle"></i> Reemplazar
                </button>
            </div>
        </div>
        <div class="card mb-0">
                    ...
                    <tr slot-scope="{ index, row }">
                        ...
                        <!-- <td>
                            ...
                            <template v-else-if="typeUser!='seller'&& row.unit_type_id !='ZZ'">
                                <button type="button" class="btn waves-effect waves-light btn-sm btn-info" @click.prevent="clickWarehouseDetail(row.warehouses)"><i class="fa fa-search"></i></button>
                            </template>
                        </td> -->
                        <td>
                            <button
            ...
            <replace-modal :showDialog.sync="showReplaceDialog"></replace-modal>

            <history
                :showDialog.sync="showHistoryDialog"
                :recordId="recordId"
            ></history>
        </div>
    </div>
...
import ReplaceModal from "./partials/replace_modal.vue";
import History from "./partials/history.vue";
export default {
    props: ["configurationInventory", "configuration", "typeUser"],
    mixins: [deletable],
    components: {
        History,
        ReplaceModal,
    ...
    created() {
        ...
        console.log(this.configurationInventory);
    },
    methods: {
        clickHistory(id) {
            this.recordId = id;

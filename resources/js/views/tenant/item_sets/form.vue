                ...
                <div class="row">
                    ...
                    <!-- <div class="col-md-6">
                        <div class="form-group" :class="{'has-danger': errors.individual_items}">
                            ...
                            <small class="text-danger" v-if="errors.individual_items" v-text="errors.individual_items[0]"></small>
                        </div>
                    </div> -->
                    ...
                    <div class="col-md-3">
                        <div
                            class="form-group"
                            :class="{ 'has-danger': errors.web_platform_id }"
                        >
                            ...
                            <small
                                class="text-danger"
                                v-if="errors.web_platform_id"
                                v-text="errors.web_platform_id[0]"
                            ></small>
                        </div>
                    </div>
                    <div class="col-md-3">
                    ...
                    <div
                        ...
                        v-if="
                            configuration.list_items_by_warehouse &&
                            configurationInventory.item_set_by_warehouse
                        "
                    >
                        <label class="control-label"
                            >Crear en otro almacenes
                            <el-tooltip
                                class="item"
                                effect="dark"
                                content="Los productos individuales de no existir en el almacén serán creados con stock 0"
                                placement="top"
                            >
                                <i class="fa fa-info-circle"></i>
                            </el-tooltip>
                        </label>
                        <template v-if="warehouses && warehouses.length > 0">
                            <el-checkbox-group
                                v-model="form.warehousesSelected"
                            >
                                <el-checkbox
                                    ...
                                    :key="warehouse.id"
                                    :label="warehouse.id"
                                    >{{ warehouse.description }}</el-checkbox
                                >
                            </el-checkbox-group>
                        </template>
                    </div>
                        ...
                        <div class="col-md-9">
                            <div class="row">
                                ...
                                <div class="short-div col-md-4">
                                    <div class="form-group">
                                        <label class="control-label"
                                            >Total P. Compra (Referencia)
                                            <el-tooltip
                                                class="item"
                                                effect="dark"
                                                content="Suma de los precios unitarios (compra) de cada producto agregado"
                                                placement="top-start"
                                            >
                                                <i
                                                    class="fa fa-info-circle"
...
export default {
    ...
    methods: {
        changeWarehouse() {
            this.form.warehousesSelected = [];
            this.form.individual_items = [];
            this.total = 0;
        ...
        calculateTotal() {
            ...
            this.form.individual_items.forEach((row) => {
                ...
                this.total_purchase +=
                    parseFloat(row.purchase_unit_price) * row.quantity;
            });
        },
        setTotalPurchase() {

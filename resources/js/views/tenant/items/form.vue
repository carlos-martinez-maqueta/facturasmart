            ...
            <el-tabs v-model="activeName">
                <el-tab-pane class name="first">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div
                                :class="{ 'has-danger': errors.genero }"
                                class="form-group"
                            >
                        ...
                        <div class="col-md-3">
                            ...
                            >
                                <label class="control-label">
                                    {{
                                        showPharmaElement
                                            ? "Principio activo" : item_complements ? "Complementos"
                                            : "Especificaciones "
                                    }}

                                    <el-tooltip
                                        class="item"
                                        content="Para habilitar la búsqueda por especificaciones del producto, debes activarlo en Configuración > Avanzado > Visual > Buscar productos según sus especificaciones."
                                        effect="dark"
                                        placement="top"
                                    >
                                        <i class="fa fa-info-circle"></i>
                ...
                <el-tab-pane class v-if="config.condition_payment_items" name="conditions">
                    <span slot="label">Condición de pago</span>
                    <div class="row">
                        <div class="col-12">
                            <h5 class="separator-title mt-0">
                                Precios por condición de pago
                            </h5>
                            <div class="table-responsive">
                                <table class="table table-bordered">
                                    <tbody>
                                        <tr
                                            v-for="item in form.payment_conditions"
                                            :key="item.id"
                                        >
                                            <td>{{ item.name }}</td>
                                            <td width="150">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    >
                                        ...
                                        >
                                        <el-select
                                            v-model="form.id_cupones"
                                            clearable
                                            filterable
                                            placeholder="Seleccionar"
                                        >
                                            <el-option
                                                v-for="(option, idx) in coupons"
                                                :key="idx"
                                                :label="option.nombre"
                                                :value="option.id"
                                            ></el-option>
                                        ...
                                        <small
                                            v-if="errors.id_cupones"
                                            class="text-danger"
                                            v-text="errors.id_cupones[0]"
                                        ></small>
                                    </div>
                                </div>
...
import InputLotsWithoutStock from "./partials/lots_without_stock.vue";
    ...
    methods: {
        fetchCoupons() {
            axios
                ...
                .then((response) => {
                    console.log("Datos de cupones recibidos:", response.data); // Añade este mensaje
        ...
        setDefaultConfiguration() {
            ...
            this.$http.get(`/configurations/record`).then((response) => {
                ...
                this.item_complements = this.form.item_complements 

        ...
        <form autocomplete="off" @submit.prevent="clickAddItem">
                ...
                <div class="row">
                    ...
                    <template v-if="form.item_unit_types.length != 0">
                        ...
                        <div class="col-md-3">
                            ...
                            >
                                <el-option
                                    v-for="(row, idx) in form.item_unit_types"
                                    :key="idx"
                                    :value="row.id"
            ...
            <!-- <div class="row hidden-md-up form-actions text-center">
                ...
                <div class="col-6">
                    ...
                    >
                        <el-button slot="reference" @click.prevent="close()">
                            Cerrar
                        </el-button>
                    </el-popover>
                </div>
...
export default {
    ...
    methods: {
        ...
        async create() {
            ...
            console.log(
                "🚀 ~ file: item.vue:1429 ~ create ~ active_warehouse_prices:",

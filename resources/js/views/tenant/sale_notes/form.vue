<template>
    <div class="card mb-0 pt-2 pt-md-0" v-loading="loading">
                        ...
                        <div class="row mt-1">
                            ...
                            >
                                ...
                                >
                                    ...
                                    <small
                                        class="text-danger"
                                        v-if="errors.child_id"
                                        v-text="errors.child_id[0]"
                                    ></small>
                                </div>
                            </div>
                            <div
                            ...
                            <div
                                v-if="config.dispatchers_packers_document"
                            ...
                            >
                                ...
                                >
                                    ...
                                    <el-select
                                        v-model="form.person_dispatcher_id"
                                    ...
                                    <small
                                        v-if="errors.person_dispatcher_id"
                                        class="text-danger"
                                        v-text="errors.person_dispatcher_id[0]"
                                    ></small>
                                </div>
                            </div>
                            ...
                            >
                                <div
                                    :class="{
                                        'has-danger': errors.person_packer_id,
                                    }"
                                    class="form-group"
                                >
                                    <label class="control-label"
                                    ...
                                    <small
                                        ...
                                        class="text-danger"
                                        v-text="errors.person_packer_id[0]"
                                    ></small>
                                </div>
                            </div>
                            <div
                            ...
                            >
                                <div
                                    v-if="configuration.show_dispatcher_documents_sale_notes_order_note"
                                    :class="{
                                                ...
                                                <th width="15%">
                                                    <a
                                                        ...
                                                        @click.prevent="
                                                            clickAddPayment
                                                        "
                                                        class="text-center font-weight-bold text-info ml-3 pl-3"
                                                        >[+ Agregar]</a
                                                    >
                                                </th>
                                            </template>
                        ...
                        <div class="row mt-4">
                                        ...
                                        <tbody v-if="form.items.length > 0">
                                            ...
                                            >
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <button type="button" class="btn waves-effect waves-light btn-sm btn-danger" @click.prevent="clickDeleteSNItem(row.id, index)">x</button>
                                                </template> -->
                                                    <!-- <template v-if="row.record_id">
                                                    <button type="button" class="btn waves-effect waves-light btn-sm btn-danger" @click.prevent="clickDeleteSNItem(row.record_id, index)">x</button>
                                                </template>
                                                <template v-else> -->
                                                    <button
                                                        type="button"
                            ...
                            <div class="col-md-12">
                                ...
                                <p class="text-end" v-if="form.total_free > 0">
                                    ...
                                    {{
                                        form.total_free.toFixed(decimalQuantity)
                                    }}
                                </p>
                                <p
                                    class="text-end"
                                ...
                                <p class="text-end" v-if="form.total_igv > 0">
                                    ...
                                    {{
                                        form.total_igv.toFixed(decimalQuantity)
                                    }}
                                </p>
                                <p
                                    class="text-end"
                                ...
                                <div class="row mt-1" v-if="form.total > 0">
                                    <div
                                        class="col-lg-10 text-end mt-1 text-end"
                                    >
                                        <label class="control-label"
                                            >OTROS CARGOS:
                                        </label>
        ...
        <sale-notes-form-item
            ...
            @add="addRow"
            :paymentConditionId="form.payment_condition_id"
        ></sale-notes-form-item>
    ...
    methods: {
        ...
        searchRemoteChildren(input) {
            if (input.length > 2) {
                ...
                this.$http
                    .post(`/suscription/client/records`, { ...parameters })
                    .then((response) => {
                        const { data } = response;
        ...
        changePaymentMethodType(index) {
            ...
            let { is_credit, number_days } = payment_method_type;
            if (is_credit && number_days > 0) {
                this.form.due_date = moment(this.form.date_of_issue)
                    .add(number_days, "days")
                    .format("YYYY-MM-DD");
            } else {
                this.form.due_date = this.form.date_of_issue;
                this.readonly_due_date = false;
        ...
        getPaymentDestinationId() {
            if (
                ...
                let cash = _.find(this.payment_destinations, { id: "cash" });
                console.log("getPaymentDestinationId", cash);
        ...
        async isUpdate() {
            if (this.id) {
                await this.$http
                    ...
                    .then(async (response) => {
                        ...
                        if (customer_id) {
                            this.$http
                                .get(
                                    `/${this.resource}/search/customer/${customer_id}`
                                )
                                .then((response) => {
                                    this.customers = response.data.customers;
                                    this.form.customer_id = customer_id;
                                    this.getAdvanceThen(customer_id);
                                });
                        }
                        this.userId = response.data.data.seller_id;
                        console.log("Q response.data.data", response.data.data);
                        if (this.form.periods && this.form.periods.length > 0) {
                            this.monthsSelected = this.formatRecords(
                                this.form.periods
                            );
                            this.setMonths();
                        }
                ...
                await this.$http
                    .get(`/${this.resource}/paymentdestinations/${this.userId}`)
                    .then((response) => {

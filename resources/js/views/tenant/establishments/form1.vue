                            ...
                            <div class="col-md-4">
                                ...
                                >
                                    <label class="control-label"
                                        ...
                                        <div slot="content">
                                        <b>
                                            - Código del Establecimiento Principal: Siempre es "0000".<br />
                                            - Código de las Sucursales: Se asignan de forma secuencial como "0001", "0002", "0003", etc.<br /> <br />

                                            Es importante verificar en la web de Sunat, en consulta de RUC y establecimientos anexo. <br />
                                            Si se ingresa un código incorrecto, los comprobantes emitidos no tendrán valor legal.
                                        </b>
                                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                ...
                                >
                                    <div slot="content">
                                    <b>
                                        Consulte a su contador si este porcentaje es aplicable a su actividad<br />
                                        Normalmente se utiliza para hoteles y restaurantes según la Ley 31556.
                                    </b>
                                    </div>
                                    <i class="fa fa-info-circle"></i>
                                </el-tooltip>

<template>
    <div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body no-gutters">
                                <div class="row">
                                    ...
                                    <div
                                        v-if="
                                            config.dispatchers_packers_document
                                        "
                                        class="col-lg-2 col-sm-6 col-6 col-xl-2 align-self-end"
                                    >
                                        <div
                                        ...
                                        >
                                            ...
                                            <el-select
                                                v-model="
                                                    form.person_dispatcher_id
                                                "
                                                @change="changePersonDispatcher"
                                                filterable
                                                clearable
                                            >
                                                <el-option
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            <el-select
                                                v-model="form.person_packer_id"
                                                @change="changePersonPacker"
                                                filterable
                                                clearable
                                            >
                                                <el-option
                                            ...
                                            <small
                                                v-if="errors.person_packer_id"
                                                class="text-danger"
                                                v-text="
                                                    errors.person_packer_id[0]
                                                "
                                            ></small>
                                        </div>
                                    </div>
                                    <div
                                        v-if="
                                            configuration.show_dispatcher_documents_sale_notes_order_note
                                        "
                                        class="col-lg-2 col-sm-6 col-6 col-xl-2 align-self-end"
                                    >
                                        <div
                            ...
                            <div class="card-body border-top no-gutters">
                                    ...
                                    >
                                        <label class="control-label">
                                            ...
                                            <template
                                                v-if="
                                                    hasPendingCredits &&
                                                    config.show_pending_credits
                                                "
                                            >
                                                <a
                                                    :href="`/finances/unpaid?customer_id=${form.customer_id}`"
                                                    class="text-danger"
                                                    target="_blank"
                                                >
                                                    <!-- //alert o bell  icon -->
                                ...
                                <div
                                    class="row"
                                    v-if="configuration.create_items_fast"
                                >
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <el-input
                                                v-model="
                                                    form_item_quick.sale_unit_price
                                                "
                                            ></el-input>
                                        </div>
                                    </div>
                                ...
                                <div class="row" v-if="configuration.college">
                                    <div
                                        ...
                                        class="form-group col-md-6 col-sm-12 mb-0"
                                    >
                                        <label
                            ...
                            <div class="row">
                                ...
                                <template
                                    v-if="
                                        configuration.show_upload_items_excel_document
                                    "
                                >
                                    <div class="col-xl-3 col-md-3 col-12 pb-2">
                                        <el-popover
                                    ...
                                    >
                                        <el-collapse-item name="1">
                                            ...
                                            <div class="col-xl-12 col-md-12">
                                                <div class="row">
                                                    <div
                                                        class="col-xl-3 col-md-3 col-12 pt-2 pb-2"
                                                    >
                                                        <span class="mr-2"
                                                            >Comprobante
                                                            contingencia</span
                                ...
                                <div class="table-responsive">
                                    <table class="table table-sm">
                                        ...
                                        <tbody>
                                            ...
                                            <tr
                                                v-if="
                                                    config.show_total_quantity_document
                                                "
                                            >
                                                <td></td>
                                                <td
                                                            ...
                                                            >
                                                                        ...
                                                                        >
                                                                            ...
                                                                            {{
                                                                                form
                                                                                    .detraction
                                                                                    .amount
                                                                                    ? form.detraction.amount.toFixed(
                                                                                          decimalQuantity
                                                                                      )
                                                                                    : ""
                                                                            }}
                                                                ...
                                                                >
                                                                    ...
                                                                    >
                                                                        ...
                                                                        {{
                                                                            form.total_exportation
                                                                                ? form.total_exportation.toFixed(
                                                                                      decimalQuantity
                                                                                  )
                                                                                : ""
                                                                        }}
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            >
                                                                                ...
                                                                                >
                                                                                    ...
                                                                                    <el-tooltip
                                                                                        class="item"
                                                                                        content="Número de operación o comprobante de caja chica"
                                                                                        effect="dark"
                                                                                        placement="top-start"
                                                                                    >
                                                                                        <i
                                                                                ...
                                                                                >
                                                                                    ...
                                                                                    <el-tooltip
                                                                                        class="item"
                                                                                        content="Detalle, comentario o descripción de la transacción"
                                                                                        effect="dark"
                                                                                        placement="top-start"
                                                                                    >
                                                                                        <i
        ...
        <document-form-item
            ...
            @add="addRow"
            :payment-condition-id="form.payment_condition_id"
        ></document-form-item>
        ...
        <discount-permission
            ...
            :sellers-discount-limit="configuration.sellers_discount_limit"
            @tokenValidated="tokenValidated"
            :itemExtraPercentages="itemExtraPercentages"
        ></discount-permission>
    </div>
</template>
...
import DiscountPermissionForm from "../../tenant/pos/partials/discount_permission.vue";
...
export default {
    ...
    async created() {
        ...
        try {
            ...
            this.person_packers = response.data.person_packers;
            this.person_dispatchers = response.data.person_dispatchers;
    ...
    methods: {
        ...
        foundBigPart(unit_price) {
            let maxQuantity = 650 / unit_price;
            let decimal = Math.round(maxQuantity * 100) / 100;
            let parts = [decimal];
            while (parts.reduce((a, b) => a + b, 0) < 1) {
                let rest = 1 - parts.reduce((a, b) => a + b, 0);
        ...
        groupItems() {
            ...
            console.log("🚀 ~ groupItems ~ items:", items);
            let results = [];
            let currentGroup = [];
            let currentTotal = 0;
        ...
        changeDescriptionItem(row, index) {
            setTimeout(() => {
                row.edit_description = false;
                row.name_product_pdf = `<p>${row.item.description}</p>`;
                console.log("🚀 ~ setTimeout ~ row:", row);
                this.form.items[index] = row;
            }, 1500);
        },
        ...
        getItemByIdAndAdd(id, quantity) {
            this.$http
                ...
                .catch((error) => {
                    console.log("🚀 ~ getItemByIdAndAdd ~ error:", error);
                });
        },
        addItemQuick() {
            ...
            this.$http
                ...
                .catch((error) => {
                    console.log("🚀 ~ addItemQuick ~ error:", error);
                })
                .finally(() => {
                    this.initQuickFormItem();
                });
        ...
        changeTotalDiscountItem(item, index) {
            ...
            // this.currentDiscounts = row.discounts;
            // const validate_restrict_seller_discount =
            //     this.validateRestrictSellerDiscount(row.discounts);
            // if (!validate_restrict_seller_discount.success) {
            //     item.discounts = [];
            //     row = calculateRowItem(
            //         item,
            //         this.form.currency_type_id,
            //         this.form.exchange_rate_sale,
            //         this.percentage_igv
        ...
        changeTotalValueItem(item, index) {
            console.log("🚀 ~ changeTotalValueItem ~ item:", item);
            if (this.timer) clearTimeout(this.timer);
            this.timer = setTimeout(() => {
        ...
        clickAddInitGuides() {
            //checar si  this.form.guides es un array, sino lo es castear de objeto a array
        ...
        discountGlobal() {
            ...
            console.log(
                "🚀 ~ discountGlobal ~ total_affected:",
                total_affected
            );
            let total_inaffected = this.getTotalInaffected();
            console.log(
                "🚀 ~ discountGlobal ~ total_inaffected:",
                total_inaffected
            );
            let input_global_discount = parseFloat(this.total_global_discount);
            if (input_global_discount > 0) {
                ...
                if (this.isGlobalDiscountBase) {
                    ...
                    console.log(
                        "🚀 ~ discountGlobal ~ this.form.total_taxed:",
                    ...
                    console.log(
                        "🚀 ~ discountGlobal ~ this.form.total:",
                        this.form.total
                    );
                    if (this.form.total <= 0.05)
                        this.$message.error(

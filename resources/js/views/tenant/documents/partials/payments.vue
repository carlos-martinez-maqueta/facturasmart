                                ...
                                >
                                    <template v-if="row.id">
                                        ...
                                        <td class="text-left">
                                            ...
                                            >
                                                ...
                                                <button
                                                    type="button"
                                                    v-if="row.filename"
                                                    class="btn waves-effect waves-light btn-sm btn-primary mb-2 mt-2"
                                                    @click.prevent="
                                                        clickDownloadFile(
                                                            row.filename
                                                        )
                                                ...
                                                >
                                                    <i
                                                        class="fas fa-fw fa-file-download"
                                                    ></i>
                                                    Descargar voucher
                                                </button>
                                            ...
                                            <template v-else>
                                                <span
                                                    class="d-block mb-2 font-bold"
                                                    >{{
                                                        row.payment_received_description
                                                    }}</span
                                                >

                                                <template
                                                    v-if="row.payment_received"
                                                >
                                                    <span
                                                        class="d-block"
                                                        v-if="row.reference"
                                        ...
                                        >
                                            ...
                                            <el-tooltip
                                                v-if="row.is_from_sale_note"
                                                content="Este pago proviene de una nota de venta"
                                                placement="top"
                                                effect="dark"
                                            >
                                                <el-tag type="warning"
                                    ...
                                    <template v-else>
                                        ...
                                        <td
                                            class="series-table-actions text-end px-0"
                                        >
                                            <button
                                                type="button"
...
export default {
    ...
    methods: {
        ...
        validateDataPayment(row) {
            ...
            if (!row.payment || row.payment <= 0 || isNaN(row.payment))
                return this.getObjectResponse(
                    false,
                    "El campo monto es obligatorio y debe ser mayor que 0."
                );
        ...
        showDialogLinkPayment(row) {
            if (!row.id) {
                ...
                if (!validate_data_payment.success)
                    return this.$message.error(validate_data_payment.message);
            }
        ...
        clickPrint(external_id) {
            window.open(
                `/finances/unpaid/print/${external_id}/document`,
                "_blank"
            );
        },
        clickOptionsPrint() {

                        ...
                        <div class="table-responsive">
                            <table class="table table-sm">
                                ...
                                <tr>
                                    ...
                                    <th class="text-end font-weight-bold">Valor U.</th>
                                    <th class="text-end font-weight-bold">Precio U.</th>
                                ...
                                <tr>
                                    ...
                                    <td class="p-0"
                                        ...
                                        <div class="row table-responsive">
                                            <table class="table-sm text-end hidden-sm-down"
                                                   style="width: 100%;">
                            ...
                            <div class="card-body p-2 border-top">
                                <div class="col-12 py-2 px-0">
                                    <div class="row no-gutters">
                                        <div class="col-10">Comprobante de Contingencia</div>
                                        <div class="col-2">
                                ...
                                <template v-if="!is_client">
                                    <div class="col-12 py-2 px-0">
                                        <div class="row no-gutters">
                                            <div class="col-10">Pago anticipado</div>
                                            <div class="col-2">
                                    ...
                                    <div class="col-12 py-2 px-0"
                                        ...
                                        <div class="row no-gutters">
                                            <div class="col-10">Comprobante con retención</div>
                                            <div class="col-2">
...
export default {
    ...
    async created() {
        ...
        if (this.documentId) {
            ...
            if (this.tableId) {
                let its = [];
                await this.$http.get(`/${this.table}/data/${this.tableId}`)
                    .then(response => {
                        console.log(response.data);
                        this.form = Object.assign({}, this.form, response.data.form);
                        its = response.data.items

                        //this.onSetFormData(response.data.data.quotation);
                    })
                    .finally(() => this.loading_submit = false);

                _.forEach(its, it => {
                    this.form.items.push(calculateRowItem(it, this.form.currency_type_id, this.form.exchange_rate_sale))
                });
                this.calculateTotal()
                // _.forEach(its, it => {
                //     console.log('00000000')
                //     this.form.items.push(JSON.parse(JSON.stringify(it)));
                // })
        ...
        discountGlobal() {
            ...
            if (input_global_discount > 0) {
                ...
                if (this.isGlobalDiscountBase) {
                    ...
                    if (this.form.total <= 0.05) this.$message.error("El total debe ser mayor a 0, verifique el tipo de descuento asignado (Configuración/Avanzado/Contable)")

<template>
    <el-dialog :title="titleDialog" :visible="showDialog" @open="create" width="30%"
        ...
        <div class="row">
            <template v-if="configuration.show_sale_price_pdf">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 text-center font-weight-bold mt-3">
                    <button type="button" class="btn btn-lg btn-info waves-effect waves-light" @click="clickPrint('a4_precios')">
                        <i class="fa fa-file-alt"></i>
                    </button>
                    <p>Imprimir A4 <br> P. venta</p>
                </div>
            </template>
            <template v-else>
...
<script>
    ...
    export default {
        props: ['showDialog', 'recordId', 'showClose', 'type', 'configuration'],
        data() {
            return {
                titleDialog: null,
                loading: false,

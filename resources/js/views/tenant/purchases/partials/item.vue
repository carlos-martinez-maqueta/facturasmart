<template>
    ...
    >
        ...
        <form autocomplete="off" @submit.prevent="clickAddItem">
            ...
            <el-tabs v-model="activeName">
                <el-tab-pane class name="first">
                    ...
                    <div class="row">
                        <div class="row mt-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <el-input
                                    v-if="
                                        form.item.currency_type_id !== undefined
                                    "
                        ...
                        <div class="row mt-3">
                            <div class="col-md-4">
                                <el-checkbox
                                    v-model="form.update_purchase_price"
                                >
                            ...
                            <div class="col-md-4">
                                <el-checkbox
                                    v-show="!isLotEnabled"
                                    v-model="form.update_date_of_due"
                                >
                                    Asignar Fecha de vencimiento
                                </el-checkbox>
                            </div>
                        </div>
                        <div v-if="isClothesShoes" class="row mt-2">
                            <div class="col-md-3">
                                <el-button
                                    v-if="form.has_sizes"
                    ...
                    <div
                        v-if="canSetDateOfDue && !isLotEnabled"
                        class="col-md-2"
                    >
                        <div
                    ...
                    <div class="row mt-3">
                        ...
                        <div v-if="form.update_price" class="col-md-4">
                            <div class="form-group">
                                ...
                                <input
                                    ...
                                    step="0.01"
                                    required
                                    placeholder="Ingrese el valor de ganancia"
                                    v-model="valor_ganancia"
                                    @input="calculateSalePrice"
                                />
                                <small class="text-muted">
                                    El valor no puede ser negativo o estar vacío
                                </small>
                            </div>
                        </div>
                ...
                <el-tab-pane
                    v-show="
                        form.item_unit_types !== undefined &&
                ...
                <el-tab-pane
                    v-show="
                        form.item.item_warehouse_prices !== undefined &&
                        form.item.item_warehouse_prices.length > 0 &&
                        canEditPrice === true
                    "
                    class
                    name="third"
        ...
        <InputLotsWithoutStock
            :item_id="form.item_id"
            :lots.sync="lots"
            :showDialog.sync="showDialogLotsWithoutStock"
            :stock="form.quantity"
            @addRowLot="addRowLot"
        >
        </InputLotsWithoutStock>
...
<script>
import SizesForm from "../../items/partials/sizes.vue";
import itemForm from "../../items/form.vue";
import { calculateRowItem } from "../../../../helpers/functions";
import LotsForm from "@components/incomeLots.vue";
import InputLotsWithoutStock from "@components/InputLotsWithoutStock.vue";
...
export default {
    ...
    computed: {
        ...
        isLotEnabled() {
            if (this.form) {
                let form = this.form;
                if (form && form.item && form.item.lots_enabled) {
    ...
    created() {
        ...
        this.$http.get(`/${this.resource}/item/tables`).then((response) => {
            ...
            this.isClothesShoes = response.data.clothesShoes;
    ...
    methods: {
        ...
        async open() {
            if (this.item) {
                ...
                this.form.sizes = this.item.item.sizes_added;
        ...
        calculateSalePrice() {
            let base_price = this.form.unit_price * this.valor_ganancia;
            if (this.include_igv) {
                base_price *= 1.18;
            }
            this.sale_unit_price = base_price;
        },
        ...
        clickLotcode() {
            // if (this.configuration.input_series_without_stock) {
        ...
        initForm() {
            ...
            if (
                ...
                this.config.warehouse_id !== undefined
            ) {
            ...
            this.form = {
                ...
                update_purchase_price:
                    this.config.checked_update_purchase_price,
        ...
        changeItem() {
            ...
            this.form.affectation_igv_type_id =
                this.form.item.purchase_affectation_igv_type_id;
            ...
            this.form.system_isc_type_id =
                this.form.item.purchase_system_isc_type_id;
        },
        ...
        changeItemAlt() {
            ...
            this.form.item = item;
            this.form.item = this.setExtraFieldOfitem(this.form.item);
            let saleUnitPrice = (item.sale_unit_price = finalPrice);
            this.sale_unit_price = parseFloat(saleUnitPrice).toFixed(2);
            this.form.unit_price = this.form.item.purchase_unit_price;
            this.form.affectation_igv_type_id =
                this.form.item.purchase_affectation_igv_type_id;
        ...
        async clickAddItem() {
            ...
            if (
                ...
                unit_price = this.form.purchase_has_igv
            ...
            this.row.item.sizes_added = this.form.sizes;
            this.row.valor_ganancia = this.valor_ganancia;
            this.row.include_igv = this.include_igv;
            this.row.sizes = this.form.sizes;
            this.initForm();

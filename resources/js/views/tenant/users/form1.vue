                ...
                <el-tabs v-model="activeName">
                    ...
                    -->
                                ...
                                >
                                    <label class="control-label"
                                        ...
                                        <el-tooltip
                                            ...
                                            effect="dark"
                                            placement="top-start"
                                            v-if="config_regex_password_user"
                                        >
                                            <i class="fa fa-info-circle"></i>
                                            <div slot="content">
                                                <strong
                                                    ...
                                                    CONTRASEÑA</strong
                                                ><br /><br />
                                                La contraseña debe contener al
                                                menos una letra minúscula.<br />
                                                La contraseña debe contener al
                                                menos una letra mayúscula.<br />
                                                La contraseña debe contener al
                                                menos un dígito.<br />
                                                La contraseña debe contener al
                            ...
                            <div v-show="form.id" class="col-md-8">
                                <div
                                    :class="{ 'has-danger': errors.api_token }"
                                    class="form-group"
                                >
                                    <label class="control-label"
                                        >Api Token</label
                            ...
                            <div v-show="form.id" class="col-md-3">
                                ...
                                <el-button @click.prevent="updateToken()">
                                    Generar Token
                                </el-button>
                            </div>
                        </div>
                    ...
                    <el-tab-pane class name="second">
                        ...
                        <div class="row">
                            ...
                            >
                                <div class="form-comtrol">
                                    <label class="control-label"
                                        >Permisos Módulos</label
                                    >
                                    <div
                                        class="form-group tree-container-admin"
                                    >
                                        <el-tree
                                            ref="tree"
                                            :check-strictly="true"
                        ...
                        <div class="row" v-if="typeUser != 'integrator'">
                            <div class="col-md-12 mt-4">
                                <div class="form-comtrol">
                                    <label class="control-label"
                                        >Otros Permisos</label
                                    >
                                </div>
                            </div>
                            <div
                                class="col-md-4 mt-1"
                                v-if="config_permission_to_edit_cpe"
                            >
                                <div class="form-comtrol">
                                    <el-checkbox
                                        v-model="form.permission_edit_cpe"
                                    >
                                        Editar CPE
                                    </el-checkbox>
                                </div>
                            ...
                            <div class="col-md-4 mt-1">
                                <div class="form-comtrol">
                                    <el-checkbox
                                        v-model="form.recreate_documents"
                                    >
                                        Recrear documentos
                                        <el-tooltip
                                                    class="item"
                                                ...
                                                >
                                                    <div slot="content">
                                                    <b>
                                                        La función de recrear documentos permite cambiar el estado de un comprobante al estado "registrado"<br />
                                                        para que pueda ser modificado o regularizado según sea necesario. Sin embargo, es importante destacar <br />
                                                        que no se debe modificar el contenido de documentos ya aceptados por Sunat, ya que esto constituiría <br />
                                                        una adulteración de comprobantes y generaría inconsistencias en el SIRE.
                                                    </b>
                                                    </div>
                                                    <i class="fa fa-info-circle"></i>
                                            </el-tooltip>
                            ...
                            >
                                <div class="form-comtrol">
                                    ...
                                    >
                                        <el-checkbox
                                            v-model="
                                                form.permission_force_send_by_summary
                                            "
                                        >
                            ...
                            <div class="col-md-4 mt-1">
                                <div class="form-comtrol">
                                    <el-checkbox v-model="form.auditor">
                                        Auditor
                                            <el-tooltip
                                                    class="item"
                                                    effect="dark"
                                                ...
                                                >
                                                    <div slot="content">
                                                    <b>
                                                        El modo auditor permite cambiar el estado de los comprobantes de manera libre,  <br />
                                                        siendo útil para homologar la información que posee Sunat con la del sistema facturador. <br />
                                                        Este modo se utiliza para regularizar el estado de los comprobantes y también permite <br />
                                                        modificar el usuario que emitió los comprobantes, habilitando la edición de los documentos.<br /> <br />

                                                        Es importante que el modo auditor sea utilizado únicamente por personal capacitado y siempre <br />
                                                        después de una corroboración previa en la web de Sunat para evitar inconsistencias o errores.
                                                    </b>
                                                    </div>
                                                    <i class="fa fa-info-circle"></i>
                                            </el-tooltip>
                    ...
                    <el-tab-pane class name="third">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div
                                    :class="{ 'has-danger': errors.last_names }"
                                    class="form-group"
                                >
                                    <label class="control-label"
                                        >Apellidos</label
                                    ...
                                    ></el-input>
                                    <small
                                        v-if="errors.last_names"
                                        class="text-danger"
                                        v-text="errors.last_names[0]"
                                    ></small>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div
                                    :class="{
                                        'has-danger': errors.date_of_birth,
                                    }"
                                    class="form-group"
                                >
                                    <label class="control-label"
                            ...
                            <div class="col-md-6">
                                <div
                                    :class="{
                                        'has-danger': errors.personal_email,
                                    }"
                                    class="form-group"
                                >
                                    <label class="control-label"
                                    ...
                                    <small
                                        ...
                                        class="text-danger"
                                        v-text="errors.personal_email[0]"
                                    ></small>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div
                                    :class="{
                                        'has-danger':
                                            errors.personal_cell_phone,
                                    }"
                                    class="form-group"
                                >
                                    <label class="control-label"
                                        >N° Celular personal</label
                                    >
                                    <el-input
                                        v-model="form.personal_cell_phone"
                                    ></el-input>
                                    <small
                                        v-if="errors.personal_cell_phone"
                                        class="text-danger"
                                        v-text="errors.personal_cell_phone[0]"
                                    ></small>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div
                                    :class="{
                                        'has-danger': errors.corporate_email,
                                    }"
                                    class="form-group"
                                >
                                    <label class="control-label"
                                    ...
                                    ></el-input>
                                    <small
                                        v-if="errors.corporate_email"
                                        class="text-danger"
                                        v-text="errors.corporate_email[0]"
                                    ></small>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div
                                    :class="{
                                        'has-danger': errors.contract_date,
                                    }"
                                    class="form-group"
                                >
                                    <label class="control-label"
                                    ...
                                    ></el-date-picker>
                                    <small
                                        v-if="errors.contract_date"
                                        class="text-danger"
                                        v-text="errors.contract_date[0]"
                                    ></small>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div
                                    :class="{
                                        'has-danger':
                                            errors.corporate_cell_phone,
                                    }"
                                    class="form-group"
                                >
                                    <label class="control-label"
                                        >N° Celular corporativo</label
                                    >
                                    <el-input
                                        v-model="form.corporate_cell_phone"
                                    ></el-input>
                                    <small
                                        v-if="errors.corporate_cell_phone"
                                        class="text-danger"
                                        v-text="errors.corporate_cell_phone[0]"
                                    ></small>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div
                                    :class="{ 'has-danger': errors.position }"
                                    class="form-group"
                                >
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    >
                                        <img
                                            v-if="form.photo_temp_image"
                                            :src="form.photo_temp_image"
                                            class="avatar"
                                        />
                                        <i
                                            v-else
                    ...
                    <el-tab-pane class name="fourth">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <label class="control-label"
                                    >¿Múltiples tipos de documento por
                                    defecto?</label
                                >
                                <div class="form-group">
                                    <el-switch
                                        v-model="
                                            form.multiple_default_document_types
                                        "
                                        active-text="Si"
                                        inactive-text="No"
                                        @change="
                            ...
                            <template
                                v-if="form.multiple_default_document_types"
                            >
                                    ...
                                    >
                                        ...
                                        <tbody>
                                            <tr
                                                v-for="(
                                                    row, index
                                                ) in form.default_document_types"
                                                :key="index"
                                                width="100%"
                                            >
                                                <td>
                                                    ...
                                                    >
                                                        ...
                                                        <template
                                                            v-if="
                                                                errors[
                                                                    `default_document_types.${index}.document_type_id`
                                                                ]
                                                            "
                                                        >
                                                            <div
                                                ...
                                                <td>
                                                    ...
                                                    >
                                                        ...
                                                        >
                                                            <el-option
                                                                v-for="option in row.default_series"
                                                                :key="option.id"
                                                                :value="
                                                                    option.id
                                                                "
                                                        ...
                                                        <template
                                                            v-if="
                                                                errors[
                                                                    `default_document_types.${index}.series_id`
                                                                ]
                                                            "
                                                        >
                                                            <div
                                                ...
                                                >
                                                    <button
                                                        ...
                                                        @click.prevent="
                                                            clickDeleteDefaultDocumentType(
                                                                index
                                                            )
                                                        "
                                                    >
                        ...
                        >
                            ...
                            <div class="row">
                                <div class="col-md-3 col-lg-3">
                                    ...
                                    >
                                    <el-select
                                        v-model="form.integrate_user_type_id"
                                        clearable
                                        filterable
                                    >
                                        <el-option
    ...
    async created() {
        await this.$http.get(`/${this.resource}/tables`).then((response) => {
            ...
            this.config_permission_to_edit_cpe =
                response.data.config_permission_to_edit_cpe;
            this.config_regex_password_user =
                response.data.config_regex_password_user;
            this.identity_document_types =
                response.data.identity_document_types;
            this.document_types = this.filterDocumentTypes(
    ...
    methods: {
        ...
        initDataDefaultDocumentTypes(init_series_id = true) {
            this.form.default_document_types.forEach((row) => {
                ...
                row.default_series = this.getDefaultDocumentTypeSeries(
                    row.document_type_id
                );
            });
        },
        clickAddDefaultDocumentType() {
            if (!this.form.establishment_id)
                return this.$message.warning(
                    "Seleccione un establecimiento para buscar las series disponibles."
                );
        ...
        changeDefaultDocumentType(index) {
            ...
            const current_document_type_id =
                this.form.default_document_types[index].document_type_id;

            const exist_document_type = this.getExistDocumentType(
            ...
            this.form.default_document_types[index].default_series =
                this.getDefaultDocumentTypeSeries(current_document_type_id);
        },
        getExistDocumentType(current_document_type_id, index) {
            return this.form.default_document_types.find((row, row_index) => {
                return (
                    row.document_type_id === current_document_type_id &&
                    index !== row_index
                );
            });
        },
        getDefaultDocumentTypeSeries(document_type_id) {
            return _.filter(this.series, {
        ...
        submit() {
            ...
            this.form.config_regex_password_user =
                this.config_regex_password_user;

            if (
                this.form.multiple_default_document_types &&
                this.form.default_document_types.length == 0
            )
                return this.$message.error(
                    "Debe agregar al menos un tipo de documento por defecto"
                );

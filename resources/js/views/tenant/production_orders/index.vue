...
export default {
    ...
    methods: {
        ...
        sendWhatsapp(row) {
            let message = `*Área de producción:* Confirmamos que la orden de pedido Nro° ${
                row.full_number.split("-")[1]
            } con el número de celular ${
                row.customer_telephone
            }, ya se encuentra listo para recojo en nuestro almacén Ate, avisar al cliente, para que pueda venir  a recogerlo. Gracias.`;
        ...
        clickViewPdf(external_id, type) {
            window.open(`/${type}/print/${external_id}/ticket`, "_blank");
        },

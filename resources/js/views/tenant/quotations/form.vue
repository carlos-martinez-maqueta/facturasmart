<template>
    <div class="card mb-0 pt-2 pt-md-0" v-loading="loading">
        ...
        <quotation-form-item
            ...
            @add="addRow"
            :paymentConditionId="form.payment_method_type_id"
...
export default {
    ...
    methods: {
        changeItemPriceCondition() {
            ...
            let payment_method_id = this.form.payment_method_type_id;
            let payment_method = this.payment_method_types.find(
                (p) => p.id === payment_method_id
            );
            if (!payment_method) return;

            let payment_condition_id =
                payment_method.is_credit == 1 ? "02" : "01";
            let changed = false;
        ...
        changeCustomer() {
            ...
            this.typeClient = customer.person_type;

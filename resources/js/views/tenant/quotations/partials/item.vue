    ...
    methods: {
        ...
        async changeItem() {
            ...
            if (
                ...
                let paymentMethod = this.paymentMethods.find(
                    (i) => i.id == this.paymentConditionId
                );
                if(paymentMethod){
                    let paymentConditionId = paymentMethod.is_credit ? "02" : "01";
                    let exists = payment_conditions.find(
                    (i) => i.payment_condition_id == paymentConditionId
                );
                if (exists) {
        ...
        async clickAddItem() {
            ...
            this.row = calculateRowItem(
                ...
                this.exchangeRateSale || 1,
                this.percentageIgv || 0.18
            );

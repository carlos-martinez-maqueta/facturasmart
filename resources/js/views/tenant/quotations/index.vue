            ...
            <div class="card-body">
                <data-table :resource="resource" :state-types="state_types">
                    <tr slot="heading">
                        ...
                        <th>Vendedor</th>
                        <th v-if="config && config.multi_companies">Empresa</th>
                    ...
                    >
                        ...
                        <td v-if="config && config.multi_companies">
                            <template
                                v-if="
                                    row.alter_company &&
                        ...
                        <td class="text-end">
                            <div class="ms-1">
                                ...
                                <div class="dropdown-menu dropdown-menu-end">
                                    ...
                                    <a
                                        v-if="row.state_type_id == '05' && row.can_create_purchase_order"
                                        :href="`/purchase-orders/generate-quotation/${row.id}`"
                                        class="dropdown-item"
                                    >
                                        Orden de compra
                                    </a>

<template>
    <div>
                    ...
                    <tr slot-scope="{ index, row }">
                        ...
                        <td>
                            <template v-if="isMobileScreen">
                                <el-button
                                    :class="`state_${row.state_id}`"
                                    @click="showChangeState(row)"
                                >
                                    {{ row.state }}
                                </el-button>
                            </template>
        ...
        ></guide-modal-view>
        <states-modal
            :showDialog.sync="showDialogState"
            :currentRecord="currentRecord"
            :states="states"
            @getRecords="update"
        ></states-modal>
...
import StatesModal from "./partials/states_modal.vue";
